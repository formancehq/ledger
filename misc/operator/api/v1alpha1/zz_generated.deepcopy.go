...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LedgerConfig) DeepCopyInto(out *LedgerConfig) {
	*out = *in
	if in.Pebble != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LedgerConfig.
func (in *LedgerConfig) DeepCopy() *LedgerConfig {
	if in == nil {
		return nil
	}
	out := new(LedgerConfig)
	in.DeepCopyInto(out)
	return out
}
