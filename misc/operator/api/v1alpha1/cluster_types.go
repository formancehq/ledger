...
// Cluster is the Schema for the ledgers API.
type Cluster struct {
...
type ClusterSpec struct {
	...
	// pod label selector defaults to the Cluster's selector when omitted.
	// +optional
...
type ClusterStatus struct {
	// Phase of the Cluster: Pending, Running, Degraded, Error.
	// +optional
