...
// our code does not emit those names, so they are NOT listed here.
{
  ...
  raft:: {
    ...
    fsm_apply_process_orders_duration: 'raft.fsm.apply.process_orders.duration',
    fsm_apply_merge_duration: 'raft.fsm.apply.merge.duration',
    fsm_apply_audit_duration: 'raft.fsm.apply.audit.duration',
    fsm_apply_process_orders_time_spent: 'raft.fsm.apply.process_orders.time_spent',
    fsm_apply_merge_time_spent: 'raft.fsm.apply.merge.time_spent',
    fsm_apply_audit_time_spent: 'raft.fsm.apply.audit.time_spent',
