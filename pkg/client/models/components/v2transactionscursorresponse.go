...
// V2TransactionsCursorResponseResource - The resource type carried by this cursor
...
// V2TransactionsCursorResponseCursor - Paginated cursor wrapping the list of transactions
