...
func (s *Transactions) CreateTransaction(ctx context.Context, request components.CreateTransactionRequest, opts ...operations.Option) (*operations.CreateTransactionResponse, error) {
