...
type Monitor interface {
	CommittedTransactions(context.Context, string, []CommitTransactionResult, Volumes)
...
func (n noOpMonitor) CommittedTransactions(ctx context.Context, s string, results []CommitTransactionResult, volumes Volumes) {
}
