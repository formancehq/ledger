...
type Monitor interface {
	CommittedTransactions(context.Context, string, []CommitTransactionResult)
...
func (n noOpMonitor) CommittedTransactions(ctx context.Context, s string, results []CommitTransactionResult) {
}
