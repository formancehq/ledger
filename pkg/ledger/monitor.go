...
type Monitor interface {
	CommittedTransactions(context.Context, string, *core.CommitResult)
...
func (n noOpMonitor) CommittedTransactions(ctx context.Context, s string, result *core.CommitResult) {
}
