...
type Monitor interface {
	CommittedTransactions(context.Context, string, []CommitTransactionResult, core.AggregatedVolumes)
...
func (n noOpMonitor) CommittedTransactions(ctx context.Context, s string, results []CommitTransactionResult, volumes core.AggregatedVolumes) {
}
