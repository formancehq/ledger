...
func (args PostgresDatabaseArgs) setup(ctx *pulumi.Context, ns pulumix.Input[string], options ...pulumi.ResourceOption) (DatabaseComponent, error) {
	uri, err := internals.UnsafeAwaitOutput(ctx.Context(), args.URI.ToOutput(ctx.Context()))
	if err != nil {
	...
	install, err := internals.UnsafeAwaitOutput(ctx.Context(), args.Install.ToOutput(ctx.Context()))
	if err != nil {
...
func (args *PostgresDatabaseArgs) SetDefaults() {}
