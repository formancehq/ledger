...
require (
	...
	github.com/formancehq/numscript v0.0.27-0.20260926085238-be0d1c923325 // pinned to numscript feat/register-vm-ir @be0d1c9 (#199, compiler+VM); repin to a tag once #199 merges
