...
// TaskModulrDescriptor struct for TaskModulrDescriptor
...
func (o TaskModulrDescriptor) MarshalJSON() ([]byte, error) {
...
type NullableTaskModulrDescriptor struct {
	value *TaskModulrDescriptor
	isSet bool
}

func (v NullableTaskModulrDescriptor) Get() *TaskModulrDescriptor {
	return v.value
}

func (v *NullableTaskModulrDescriptor) Set(val *TaskModulrDescriptor) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskModulrDescriptor) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskModulrDescriptor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskModulrDescriptor(val *TaskModulrDescriptor) *NullableTaskModulrDescriptor {
	return &NullableTaskModulrDescriptor{value: val, isSet: true}
}

func (v NullableTaskModulrDescriptor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskModulrDescriptor) UnmarshalJSON(src []byte) error {
	v.isSet = true
