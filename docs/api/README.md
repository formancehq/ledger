...
---
  ...
  /v2/_/buckets:
    get:
      summary: List buckets with their deletion status
          ...
          content:
            application/json:
              schema:
                type: array
                items:
                  $ref: "#/components/schemas/V2BucketWithStatus"
        default:
          description: Error
          content:
            application/json:
    ...
    parameters:
      - name: bucket
        ...
        schema:
          ...
          example: default
    delete:
      summary: Mark a bucket for deletion
      operationId: v2DeleteBucket
      x-speakeasy-name-override: DeleteBucket
      tags:
        - ledger.v2
      responses:
        "204":
    ...
    parameters:
      - name: bucket
        ...
        schema:
          ...
          example: default
    post:
      summary: Restore a bucket that was marked for deletion
      operationId: v2RestoreBucket
      x-speakeasy-name-override: RestoreBucket
      tags:
        - ledger.v2
      responses:
        "204":
      ...
      parameters:
        ...
        - name: cursor
          in: query
          description: >
            Parameter used in pagination requests. Maximum page size is set to
            15.
...
>       tags:
    ...
    get:
      ...
      parameters:
        ...
        - name: address
          in: path
          description: >
            Exact address of the account. It must match the following regular
            expressions pattern:
    ...
    post:
      ...
      parameters:
        ...
        - name: dryRun
          in: query
          description: >-
            Set the dry run mode. Dry run mode doesn't add the logs to the
  ...
  /v2/{ledger}/stats:
    get:
      ...
      description: >
        Get statistics from a ledger. (aggregate metrics on accounts and
        transactions)
      parameters:
        - name: ledger
          in: path
    ...
    post:
      ...
      parameters:
        ...
        - name: dryRun
          in: query
          description: >-
            Set the dryRun mode. dry run mode doesn't add the logs to the
            database or publish a message to the message broker.
          schema:
            type: boolean
            example: true
    ...
    V2BucketWithStatus:
      ...
      properties:
        ...
        deletedAt:
          type: string
          format: date-time
          description: Timestamp when the bucket was marked for deletion, null if active
          nullable: true
      required:
        - name
