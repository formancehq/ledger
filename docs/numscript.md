...
- [CLI Reference](./cli.md) - CLI usage and examples
- [Numscript Examples](../numscript/examples/README.md) - Ready-to-use example scripts
- [API Comparison](./api-comparison.md) - Feature parity with original ledger
- [Static Inputs RFC](./drafts/numscript-static-inputs-rfc.md) - RFC for static input declaration
