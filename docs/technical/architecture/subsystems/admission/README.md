...
| [bulk-performance.md](bulk-performance.md) | Request-local Numscript discovery memoization, streaming transaction JSON views, safety boundaries, and benchmark results. |
