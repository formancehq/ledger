...
| [auth.md](auth.md) | Client JWT authentication (OIDC + Ed25519) with explicit deployment audiences, scope-based authorization, and the Raft inter-node cluster-secret auth layer. |
