...
| [http-api.md](http-api.md) | HTTP REST API endpoints, response formats, ledger-log JSON discriminators and hydration, error handling, and the `apierr`/`grpcerr` error boundary crossed by a forwarded write. |
