...
For detailed implementation, see [Spool Technical Documentation](subsystems/storage/spool.md).
...
> **📋 Related**: See [Global Log Architecture](subsystems/consensus/global-log.md) for details on how the global log enables cross-ledger atomic operations.
...
1. [Raft Consensus](subsystems/consensus/raft-consensus.md) - Details on Raft replication
