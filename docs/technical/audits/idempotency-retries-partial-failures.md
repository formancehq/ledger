...
does not prove physical origin; the local shutdown proof belongs to
`grpcerr.Conn.Invoke`. Do not broaden this into all `Unavailable`, `Canceled`,
...
and one balance effect. Preserve the separate native retry control, default and
