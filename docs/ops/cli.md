...
raw integers until the rewrite completes. A binding outside the declaration's
serving window — built for a since-removed declaration, or more than one
revision behind — refuses with the retryable `INDEX_BUILDING`.
