...
1. [Raft Consensus](../technical/architecture/subsystems/consensus/raft-consensus.md) - Details on Raft
2. [Storage and Persistence](../technical/architecture/subsystems/storage/storage.md) - Storage optimizations
