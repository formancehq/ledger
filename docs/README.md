...
Kubernetes operator for deploying and managing high-availability Ledger clusters. Manages `Cluster`, `LedgerBackup`, and `LedgerClusterAgent` custom resources. Includes a `kubectl ledger` plugin and a web UI.
