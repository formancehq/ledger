...
// newPeriodsArchiveCommand creates the periods archive command.
func newPeriodsArchiveCommand() *cobra.Command {
	return &cobra.Command{
		...
		RunE:  runPeriodsArchive,
	}
}

func runPeriodsArchive(cmd *cobra.Command, args []string) error {
