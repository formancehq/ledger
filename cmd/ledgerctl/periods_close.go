...
// newPeriodsCloseCommand creates the periods close command.
func newPeriodsCloseCommand() *cobra.Command {
	return &cobra.Command{
		...
		RunE:  runPeriodsClose,
	}
}

func runPeriodsClose(cmd *cobra.Command, _ []string) error {
