...
// newTransactionsGetCommand creates the transactions get command.
func newTransactionsGetCommand() *cobra.Command {
	cmd := &cobra.Command{
...
func runTransactionsGet(cmd *cobra.Command, args []string) error {
