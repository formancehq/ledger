...
Tests administrative and operational features of the ledger: maintenance mode, audit logging, Ed25519 request signing, and ledger deletion. Focuses on ops tooling rather than financial logic.
