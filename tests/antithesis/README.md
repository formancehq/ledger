...
Run it with `-tags enable_antithesis_sdk`; without that tag, it skips because
the SDK does not emit observations.
...
- `Sometimes` is a coverage probe: its condition must be true at least once.
