...
func TestMirrorBulkAdmissionReportsLaterRequestError(t *testing.T) {
	t.Parallel()
	...
	reason, matched := individualFailureReason(state, bulk, "ACCOUNT_TYPE_ALREADY_EXISTS")
	require.True(t, matched)
	require.Equal(t, "ACCOUNT_TYPE_ALREADY_EXISTS", reason)
}
