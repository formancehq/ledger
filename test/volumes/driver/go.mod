module github.com/formancehq/ledger/tests/volumes/driver
...
require (
	...
	github.com/formancehq/ledger/pkg/client v0.0.0-20241114175329-702348109fa9
...
require (
	...
	github.com/formancehq/numscript v0.0.9 // indirect
