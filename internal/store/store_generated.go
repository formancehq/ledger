...
func (m *MockBatch) AppendBalanceDiff(ctx context.Context, ledger uint32, account, asset string, diff *big.Int) error {
	m.ctrl.T.Helper()
...
func (m *MockBatch) SaveAccountMetadata(ctx context.Context, ledger uint32, account string, arg3 *ledgerpb.Metadata) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveAccountMetadata", ctx, ledger, account, arg3)
	ret0, _ := ret[0].(error)
	return ret0
}

// SaveAccountMetadata indicates an expected call of SaveAccountMetadata.
func (mr *MockBatchMockRecorder) SaveAccountMetadata(ctx, ledger, account, arg3 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveAccountMetadata", reflect.TypeOf((*MockBatch)(nil).SaveAccountMetadata), ctx, ledger, account, arg3)
}
