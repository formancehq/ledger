...
func TestValidateAccountAddress(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "contains hyphen", input: "my-account", wantErr: ErrAccountAddressInvalidChar},
		{name: "contains underscore", input: "my_account", wantErr: ErrAccountAddressInvalidChar},
