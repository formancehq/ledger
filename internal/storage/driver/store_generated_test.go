...
func (m *MockSystemStore) ListLedgers(ctx context.Context, q ledger0.ListLedgersQuery) (*bunpaginate.Cursor[ledger.Ledger], error) {
	m.ctrl.T.Helper()
...
func (mr *MockSystemStoreMockRecorder) ListLedgers(ctx, q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListLedgers", reflect.TypeOf((*MockSystemStore)(nil).ListLedgers), ctx, q)
}
