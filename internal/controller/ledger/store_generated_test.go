...
func (m *MockResource[ResourceType, OptionsType]) Query(q ResourceQuery[OptionsType], modifiers ...func(*bun.SelectQuery) *bun.SelectQuery) (*bun.SelectQuery, error) {
	m.ctrl.T.Helper()
	varargs := []any{q}
...
func (mr *MockResourceMockRecorder[ResourceType, OptionsType]) Query(q any, modifiers ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{q}, modifiers...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Query", reflect.TypeOf((*MockResource[ResourceType, OptionsType])(nil).Query), varargs...)
}
...
func (m *MockPaginatedResource[ResourceType, OptionsType, PaginationQueryType]) List(ctx context.Context, query ResourceQuery[OptionsType], modifiers ...func(*bun.SelectQuery) *bun.SelectQuery) ([]ResourceType, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPaginatedResourceMockRecorder[ResourceType, OptionsType, PaginationQueryType]) List(ctx, query any, modifiers ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, query}, modifiers...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockPaginatedResource[ResourceType, OptionsType, PaginationQueryType])(nil).List), varargs...)
}
...
// Query mocks base method.
func (m *MockPaginatedResource[ResourceType, OptionsType, PaginationQueryType]) Query(q ResourceQuery[OptionsType], modifiers ...func(*bun.SelectQuery) *bun.SelectQuery) (*bun.SelectQuery, error) {
	m.ctrl.T.Helper()
	varargs := []any{q}
	for _, a := range modifiers {
		varargs = append(varargs, a)
...
// Query indicates an expected call of Query.
func (mr *MockPaginatedResourceMockRecorder[ResourceType, OptionsType, PaginationQueryType]) Query(q any, modifiers ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{q}, modifiers...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Query", reflect.TypeOf((*MockPaginatedResource[ResourceType, OptionsType, PaginationQueryType])(nil).Query), varargs...)
}
