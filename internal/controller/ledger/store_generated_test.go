...
func (m *MockStore) Accounts() pagination.PaginatedResource[ledger.Account, any, pagination.OffsetPaginatedQuery[any]] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Accounts")
	ret0, _ := ret[0].(pagination.PaginatedResource[ledger.Account, any, pagination.OffsetPaginatedQuery[any]])
	return ret0
}
...
func (m *MockStore) AggregatedBalances() pagination.Resource[ledger.AggregatedVolumes, ledger0.GetAggregatedVolumesOptions] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AggregatedBalances")
	ret0, _ := ret[0].(pagination.Resource[ledger.AggregatedVolumes, ledger0.GetAggregatedVolumesOptions])
	return ret0
}
...
func (m *MockStore) Logs() pagination.PaginatedResource[ledger.Log, any, pagination.ColumnPaginatedQuery[any]] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Logs")
	ret0, _ := ret[0].(pagination.PaginatedResource[ledger.Log, any, pagination.ColumnPaginatedQuery[any]])
	return ret0
}
...
func (m *MockStore) Transactions() pagination.PaginatedResource[ledger.Transaction, any, pagination.ColumnPaginatedQuery[any]] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Transactions")
	ret0, _ := ret[0].(pagination.PaginatedResource[ledger.Transaction, any, pagination.ColumnPaginatedQuery[any]])
	return ret0
}
...
func (m *MockStore) Volumes() pagination.PaginatedResource[ledger.VolumesWithBalanceByAssetByAccount, ledger0.GetVolumesOptions, pagination.OffsetPaginatedQuery[ledger0.GetVolumesOptions]] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Volumes")
	ret0, _ := ret[0].(pagination.PaginatedResource[ledger.VolumesWithBalanceByAssetByAccount, ledger0.GetVolumesOptions, pagination.OffsetPaginatedQuery[ledger0.GetVolumesOptions]])
	return ret0
}
