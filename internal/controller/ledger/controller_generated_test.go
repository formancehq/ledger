...
func (m *MockController) GetAggregatedBalances(ctx context.Context, q pagination.ResourceQuery[ledger0.GetAggregatedVolumesOptions]) (ledger.BalancesByAssets, error) {
	m.ctrl.T.Helper()
...
func (m *MockController) GetVolumesWithBalances(ctx context.Context, q pagination.OffsetPaginatedQuery[ledger0.GetVolumesOptions]) (*bunpaginate.Cursor[ledger.VolumesWithBalanceByAssetByAccount], error) {
	m.ctrl.T.Helper()
