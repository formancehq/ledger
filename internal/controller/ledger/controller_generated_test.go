...
func (m *MockController) RunQuery(ctx context.Context, schemaVersion, queryId string, parameters map[string]string) (*bunpaginate.Cursor[any], error) {
	m.ctrl.T.Helper()
...
func (mr *MockControllerMockRecorder) RunQuery(ctx, schemaVersion, queryId, parameters any) *MockControllerRunQueryCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RunQuery", reflect.TypeOf((*MockController)(nil).RunQuery), ctx, schemaVersion, queryId, parameters)
...
// Do rewrite *gomock.Call.Do
func (c *MockControllerRunQueryCall) Do(f func(context.Context, string, string, map[string]string) (*bunpaginate.Cursor[any], error)) *MockControllerRunQueryCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockControllerRunQueryCall) DoAndReturn(f func(context.Context, string, string, map[string]string) (*bunpaginate.Cursor[any], error)) *MockControllerRunQueryCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
