...
type Controller interface {
	...
	GetVolumesWithBalances(ctx context.Context, q pagination.OffsetPaginatedQuery[ledgerstore.GetVolumesOptions]) (*bunpaginate.Cursor[ledger.VolumesWithBalanceByAssetByAccount], error)
	GetAggregatedBalances(ctx context.Context, q pagination.ResourceQuery[ledgerstore.GetAggregatedVolumesOptions]) (ledger.BalancesByAssets, error)
