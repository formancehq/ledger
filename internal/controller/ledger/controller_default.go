...
func (ctrl *DefaultController) GetAggregatedBalances(ctx context.Context, q pagination.ResourceQuery[GetAggregatedVolumesOptions]) (ledger.BalancesByAssets, error) {
...
func (ctrl *DefaultController) GetVolumesWithBalances(ctx context.Context, q pagination.OffsetPaginatedQuery[GetVolumesOptions]) (*bunpaginate.Cursor[ledger.VolumesWithBalanceByAssetByAccount], error) {
