...
func (ctrl *DefaultController) saveAccountMetadata(ctx context.Context, store Store, _schema *ledger.Schema, parameters Parameters[SaveAccountMetadata]) (*ledger.SavedMetadata, error) {
