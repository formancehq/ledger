...
func (ctrl *DefaultController) ListTransactions(ctx context.Context, q resources.ColumnPaginatedQuery[any]) (*bunpaginate.Cursor[ledger.Transaction], error) {
	return ctrl.store.Transactions().Paginate(ctx, q)
}

func (ctrl *DefaultController) CountTransactions(ctx context.Context, q resources.ResourceQuery[any]) (int, error) {
	return ctrl.store.Transactions().Count(ctx, q)
}

func (ctrl *DefaultController) GetTransaction(ctx context.Context, q resources.ResourceQuery[any]) (*ledger.Transaction, error) {
	return ctrl.store.Transactions().GetOne(ctx, q)
}

func (ctrl *DefaultController) CountAccounts(ctx context.Context, q resources.ResourceQuery[any]) (int, error) {
	return ctrl.store.Accounts().Count(ctx, q)
}

func (ctrl *DefaultController) ListAccounts(ctx context.Context, q resources.OffsetPaginatedQuery[any]) (*bunpaginate.Cursor[ledger.Account], error) {
	return ctrl.store.Accounts().Paginate(ctx, q)
}

func (ctrl *DefaultController) GetAccount(ctx context.Context, q resources.ResourceQuery[any]) (*ledger.Account, error) {
	return ctrl.store.Accounts().GetOne(ctx, q)
}

func (ctrl *DefaultController) GetAggregatedBalances(ctx context.Context, q resources.ResourceQuery[GetAggregatedVolumesOptions]) (ledger.BalancesByAssets, error) {
...
func (ctrl *DefaultController) ListLogs(ctx context.Context, q resources.ColumnPaginatedQuery[any]) (*bunpaginate.Cursor[ledger.Log], error) {
	return ctrl.store.Logs().Paginate(ctx, q)
}

func (ctrl *DefaultController) GetVolumesWithBalances(ctx context.Context, q resources.OffsetPaginatedQuery[GetVolumesOptions]) (*bunpaginate.Cursor[ledger.VolumesWithBalanceByAssetByAccount], error) {
...
func (ctrl *DefaultController) Import(ctx context.Context, stream chan ledger.Log) error {
	...
	logs, err := ctrl.store.Logs().Paginate(ctx, resources.ColumnPaginatedQuery[any]{
		PageSize: 1,
	})
	if err != nil {
...
func (ctrl *DefaultController) Export(ctx context.Context, w ExportWriter) error {
	return bunpaginate.Iterate(
		...
		func(ctx context.Context, q resources.ColumnPaginatedQuery[any]) (*bunpaginate.Cursor[ledger.Log], error) {
			return ctrl.store.Logs().Paginate(ctx, q)
		},
