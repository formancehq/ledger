...
type Store interface {
	...
	Accounts() PaginatedResource[ledger.Account, any, pagination.OffsetPaginatedQuery[any]]
	Logs() PaginatedResource[ledger.Log, any, pagination.ColumnPaginatedQuery[any]]
	Transactions() PaginatedResource[ledger.Transaction, any, pagination.ColumnPaginatedQuery[any]]
	AggregatedBalances() pagination.Resource[ledger.AggregatedVolumes, GetAggregatedVolumesOptions]
	Volumes() PaginatedResource[ledger.VolumesWithBalanceByAssetByAccount, GetVolumesOptions, pagination.OffsetPaginatedQuery[GetVolumesOptions]]
}
...
type ListLedgersQuery bunpaginate.OffsetPaginatedQuery[pagination.PaginatedQueryOptions[struct{}]]
...
type PaginatedResource[ResourceType, OptionsType any, PaginationQueryType pagination.PaginatedQuery[OptionsType]] interface {
	pagination.Resource[ResourceType, OptionsType]
