...
func NewControllerWithTooManyClientHandling(underlying Controller, delayCalculator DelayCalculator) *ControllerWithTooManyClientHandling {
...
func (ctrl *ControllerWithTooManyClientHandling) CreateTransaction(ctx context.Context, parameters Parameters[RunScript]) (*ledger.CreatedTransaction, error) {
	return handleRetry(ctx, ctrl.delayCalculator, parameters, ctrl.Controller.CreateTransaction)
}
...
func (ctrl *ControllerWithTooManyClientHandling) RevertTransaction(ctx context.Context, parameters Parameters[RevertTransaction]) (*ledger.RevertedTransaction, error) {
	return handleRetry(ctx, ctrl.delayCalculator, parameters, ctrl.Controller.RevertTransaction)
}
...
func (ctrl *ControllerWithTooManyClientHandling) SaveTransactionMetadata(ctx context.Context, parameters Parameters[SaveTransactionMetadata]) error {
	_, err := handleRetry(ctx, ctrl.delayCalculator, parameters, func(ctx context.Context, parameters Parameters[SaveTransactionMetadata]) (*struct{}, error) {
...
func (ctrl *ControllerWithTooManyClientHandling) SaveAccountMetadata(ctx context.Context, parameters Parameters[SaveAccountMetadata]) error {
	_, err := handleRetry(ctx, ctrl.delayCalculator, parameters, func(ctx context.Context, parameters Parameters[SaveAccountMetadata]) (*struct{}, error) {
...
func (ctrl *ControllerWithTooManyClientHandling) DeleteTransactionMetadata(ctx context.Context, parameters Parameters[DeleteTransactionMetadata]) error {
	_, err := handleRetry(ctx, ctrl.delayCalculator, parameters, func(ctx context.Context, parameters Parameters[DeleteTransactionMetadata]) (*struct{}, error) {
...
func (ctrl *ControllerWithTooManyClientHandling) DeleteAccountMetadata(ctx context.Context, parameters Parameters[DeleteAccountMetadata]) error {
	_, err := handleRetry(ctx, ctrl.delayCalculator, parameters, func(ctx context.Context, parameters Parameters[DeleteAccountMetadata]) (*struct{}, error) {
...
func handleRetry[INPUT, OUTPUT any](ctx context.Context, delayCalculator DelayCalculator, parameters Parameters[INPUT], fn func(ctx context.Context, parameters Parameters[INPUT]) (*OUTPUT, error)) (*OUTPUT, error) {

	ctx, span := tracing.Start(ctx, "Retrier")
	defer span.End()
