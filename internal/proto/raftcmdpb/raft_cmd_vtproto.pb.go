...
func (m *LedgerApplyOrder_MigrateAccountType) CloneVT() isLedgerApplyOrder_Data {
	if m == nil {
		return (*LedgerApplyOrder_MigrateAccountType)(nil)
	}
	r := new(LedgerApplyOrder_MigrateAccountType)
	r.MigrateAccountType = m.MigrateAccountType.CloneVT()
	return r
}

func (m *LedgerApplyOrder_MigrateAccountBatch) CloneVT() isLedgerApplyOrder_Data {
	if m == nil {
		return (*LedgerApplyOrder_MigrateAccountBatch)(nil)
	}
	r := new(LedgerApplyOrder_MigrateAccountBatch)
	r.MigrateAccountBatch = m.MigrateAccountBatch.CloneVT()
	return r
}

func (m *LedgerApplyOrder_CompleteMigration) CloneVT() isLedgerApplyOrder_Data {
	if m == nil {
		return (*LedgerApplyOrder_CompleteMigration)(nil)
	}
	r := new(LedgerApplyOrder_CompleteMigration)
	r.CompleteMigration = m.CompleteMigration.CloneVT()
	return r
}

func (m *LedgerApplyOrder_CancelMigration) CloneVT() isLedgerApplyOrder_Data {
	if m == nil {
		return (*LedgerApplyOrder_CancelMigration)(nil)
	}
	r := new(LedgerApplyOrder_CancelMigration)
...
func (m *MigrateAccountTypeOrder) CloneVT() *MigrateAccountTypeOrder {
	if m == nil {
		return (*MigrateAccountTypeOrder)(nil)
	}
	r := new(MigrateAccountTypeOrder)
...
func (m *MigrateAccountTypeOrder) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *MigrateAccountBatchOrder) CloneVT() *MigrateAccountBatchOrder {
	if m == nil {
		return (*MigrateAccountBatchOrder)(nil)
	}
	r := new(MigrateAccountBatchOrder)
	r.SourceType = m.SourceType
	r.MigratedAccountsSoFar = m.MigratedAccountsSoFar
	if rhs := m.VolumeEntries; rhs != nil {
		tmpContainer := make([]*MigrateAccountEntry, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.VolumeEntries = tmpContainer
	}
	if rhs := m.MetadataEntries; rhs != nil {
		tmpContainer := make([]*MigrateAccountEntry, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.MetadataEntries = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *MigrateAccountBatchOrder) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *MigrateAccountEntry) CloneVT() *MigrateAccountEntry {
	if m == nil {
		return (*MigrateAccountEntry)(nil)
	}
	r := new(MigrateAccountEntry)
	if rhs := m.OldCanonicalKey; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.OldCanonicalKey = tmpBytes
	}
	if rhs := m.NewCanonicalKey; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.NewCanonicalKey = tmpBytes
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *MigrateAccountEntry) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *CompleteMigrationOrder) CloneVT() *CompleteMigrationOrder {
	if m == nil {
		return (*CompleteMigrationOrder)(nil)
	}
	r := new(CompleteMigrationOrder)
	r.SourceType = m.SourceType
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *CompleteMigrationOrder) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *CancelMigrationOrder) CloneVT() *CancelMigrationOrder {
	if m == nil {
		return (*CancelMigrationOrder)(nil)
	}
	r := new(CancelMigrationOrder)
	r.SourceType = m.SourceType
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *CancelMigrationOrder) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *LedgerApplyOrder_MigrateAccountType) EqualVT(thatIface isLedgerApplyOrder_Data) bool {
	that, ok := thatIface.(*LedgerApplyOrder_MigrateAccountType)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.MigrateAccountType, that.MigrateAccountType; p != q {
		if p == nil {
			p = &MigrateAccountTypeOrder{}
		}
		if q == nil {
			q = &MigrateAccountTypeOrder{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *LedgerApplyOrder_MigrateAccountBatch) EqualVT(thatIface isLedgerApplyOrder_Data) bool {
	that, ok := thatIface.(*LedgerApplyOrder_MigrateAccountBatch)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.MigrateAccountBatch, that.MigrateAccountBatch; p != q {
		if p == nil {
			p = &MigrateAccountBatchOrder{}
		}
		if q == nil {
			q = &MigrateAccountBatchOrder{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *LedgerApplyOrder_CompleteMigration) EqualVT(thatIface isLedgerApplyOrder_Data) bool {
	that, ok := thatIface.(*LedgerApplyOrder_CompleteMigration)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.CompleteMigration, that.CompleteMigration; p != q {
		if p == nil {
			p = &CompleteMigrationOrder{}
		}
		if q == nil {
			q = &CompleteMigrationOrder{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *LedgerApplyOrder_CancelMigration) EqualVT(thatIface isLedgerApplyOrder_Data) bool {
	that, ok := thatIface.(*LedgerApplyOrder_CancelMigration)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.CancelMigration, that.CancelMigration; p != q {
		if p == nil {
			p = &CancelMigrationOrder{}
		}
		if q == nil {
			q = &CancelMigrationOrder{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *MigrateAccountTypeOrder) EqualVT(that *MigrateAccountTypeOrder) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *MigrateAccountTypeOrder) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*MigrateAccountTypeOrder)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *MigrateAccountBatchOrder) EqualVT(that *MigrateAccountBatchOrder) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if len(this.VolumeEntries) != len(that.VolumeEntries) {
		return false
	}
	for i, vx := range this.VolumeEntries {
		vy := that.VolumeEntries[i]
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &MigrateAccountEntry{}
			}
			if q == nil {
				q = &MigrateAccountEntry{}
			}
			if !p.EqualVT(q) {
				return false
			}
	...
	if len(this.MetadataEntries) != len(that.MetadataEntries) {
		return false
	}
	for i, vx := range this.MetadataEntries {
		vy := that.MetadataEntries[i]
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &MigrateAccountEntry{}
			}
...
func (this *MigrateAccountBatchOrder) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*MigrateAccountBatchOrder)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *MigrateAccountEntry) EqualVT(that *MigrateAccountEntry) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	}
	if string(this.OldCanonicalKey) != string(that.OldCanonicalKey) {
		return false
	}
	if string(this.NewCanonicalKey) != string(that.NewCanonicalKey) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}

func (this *MigrateAccountEntry) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*MigrateAccountEntry)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *CompleteMigrationOrder) EqualVT(that *CompleteMigrationOrder) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *CompleteMigrationOrder) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*CompleteMigrationOrder)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *CancelMigrationOrder) EqualVT(that *CancelMigrationOrder) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *CancelMigrationOrder) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*CancelMigrationOrder)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *LedgerApplyOrder_MigrateAccountType) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *LedgerApplyOrder_MigrateAccountType) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *LedgerApplyOrder_MigrateAccountBatch) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *LedgerApplyOrder_MigrateAccountBatch) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.MigrateAccountBatch != nil {
		size, err := m.MigrateAccountBatch.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *LedgerApplyOrder_CompleteMigration) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *LedgerApplyOrder_CompleteMigration) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CompleteMigration != nil {
		size, err := m.CompleteMigration.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *LedgerApplyOrder_CancelMigration) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *LedgerApplyOrder_CancelMigration) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *MigrateAccountTypeOrder) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *MigrateAccountTypeOrder) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *MigrateAccountTypeOrder) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *MigrateAccountBatchOrder) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *MigrateAccountBatchOrder) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *MigrateAccountBatchOrder) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.MetadataEntries) > 0 {
		for iNdEx := len(m.MetadataEntries) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.MetadataEntries[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.VolumeEntries) > 0 {
		for iNdEx := len(m.VolumeEntries) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.VolumeEntries[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MigrateAccountEntry) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *MigrateAccountEntry) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *MigrateAccountEntry) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.NewCanonicalKey) > 0 {
		i -= len(m.NewCanonicalKey)
		copy(dAtA[i:], m.NewCanonicalKey)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.NewCanonicalKey)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.OldCanonicalKey) > 0 {
		i -= len(m.OldCanonicalKey)
		copy(dAtA[i:], m.OldCanonicalKey)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.OldCanonicalKey)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *CompleteMigrationOrder) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CompleteMigrationOrder) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *CompleteMigrationOrder) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *CancelMigrationOrder) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CancelMigrationOrder) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *CancelMigrationOrder) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *LedgerApplyOrder_MigrateAccountType) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LedgerApplyOrder_MigrateAccountBatch) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.MigrateAccountBatch != nil {
		l = m.MigrateAccountBatch.SizeVT()
		n += 2 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	return n
}
func (m *LedgerApplyOrder_CompleteMigration) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CompleteMigration != nil {
		l = m.CompleteMigration.SizeVT()
		n += 2 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	return n
}
func (m *LedgerApplyOrder_CancelMigration) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MigrateAccountTypeOrder) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MigrateAccountBatchOrder) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.VolumeEntries) > 0 {
		for _, e := range m.VolumeEntries {
			l = e.SizeVT()
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
	if len(m.MetadataEntries) > 0 {
		for _, e := range m.MetadataEntries {
			l = e.SizeVT()
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
...
func (m *MigrateAccountEntry) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.OldCanonicalKey)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	l = len(m.NewCanonicalKey)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
...
func (m *CompleteMigrationOrder) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CancelMigrationOrder) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LedgerApplyOrder) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			...
			if oneof, ok := m.Data.(*LedgerApplyOrder_MigrateAccountType); ok {
				if err := oneof.MigrateAccountType.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &MigrateAccountTypeOrder{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Data = &LedgerApplyOrder_MigrateAccountType{MigrateAccountType: v}
			}
			iNdEx = postIndex
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MigrateAccountBatch", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Data.(*LedgerApplyOrder_MigrateAccountBatch); ok {
				if err := oneof.MigrateAccountBatch.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &MigrateAccountBatchOrder{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Data = &LedgerApplyOrder_MigrateAccountBatch{MigrateAccountBatch: v}
			}
			iNdEx = postIndex
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompleteMigration", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Data.(*LedgerApplyOrder_CompleteMigration); ok {
				if err := oneof.CompleteMigration.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &CompleteMigrationOrder{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Data = &LedgerApplyOrder_CompleteMigration{CompleteMigration: v}
			}
			iNdEx = postIndex
		case 21:
			if wireType != 2 {
			...
			if oneof, ok := m.Data.(*LedgerApplyOrder_CancelMigration); ok {
				if err := oneof.CancelMigration.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &CancelMigrationOrder{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Data = &LedgerApplyOrder_CancelMigration{CancelMigration: v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *MigrateAccountTypeOrder) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MigrateAccountTypeOrder: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MigrateAccountTypeOrder: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MigrateAccountBatchOrder) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MigrateAccountBatchOrder: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MigrateAccountBatchOrder: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VolumeEntries", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VolumeEntries = append(m.VolumeEntries, &MigrateAccountEntry{})
			if err := m.VolumeEntries[len(m.VolumeEntries)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MetadataEntries", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MetadataEntries = append(m.MetadataEntries, &MigrateAccountEntry{})
			if err := m.MetadataEntries[len(m.MetadataEntries)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *MigrateAccountEntry) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MigrateAccountEntry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MigrateAccountEntry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OldCanonicalKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OldCanonicalKey = append(m.OldCanonicalKey[:0], dAtA[iNdEx:postIndex]...)
			if m.OldCanonicalKey == nil {
				m.OldCanonicalKey = []byte{}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewCanonicalKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NewCanonicalKey = append(m.NewCanonicalKey[:0], dAtA[iNdEx:postIndex]...)
			if m.NewCanonicalKey == nil {
				m.NewCanonicalKey = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *CompleteMigrationOrder) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CompleteMigrationOrder: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CompleteMigrationOrder: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CancelMigrationOrder) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CancelMigrationOrder: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CancelMigrationOrder: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
