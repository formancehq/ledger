...
func (m *LedgerApplyOrder_ConfigureHistoricalBalances) CloneVT() isLedgerApplyOrder_Data {
	if m == nil {
		return (*LedgerApplyOrder_ConfigureHistoricalBalances)(nil)
	}
	r := new(LedgerApplyOrder_ConfigureHistoricalBalances)
	r.ConfigureHistoricalBalances = m.ConfigureHistoricalBalances.CloneVT()
	return r
}

func (m *ConfigureHistoricalBalancesOrder) CloneVT() *ConfigureHistoricalBalancesOrder {
	if m == nil {
		return (*ConfigureHistoricalBalancesOrder)(nil)
	}
	r := new(ConfigureHistoricalBalancesOrder)
	r.Enabled = m.Enabled
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *ConfigureHistoricalBalancesOrder) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *LedgerApplyOrder_ConfigureHistoricalBalances) EqualVT(thatIface isLedgerApplyOrder_Data) bool {
	that, ok := thatIface.(*LedgerApplyOrder_ConfigureHistoricalBalances)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.ConfigureHistoricalBalances, that.ConfigureHistoricalBalances; p != q {
		if p == nil {
			p = &ConfigureHistoricalBalancesOrder{}
		}
		if q == nil {
			q = &ConfigureHistoricalBalancesOrder{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *ConfigureHistoricalBalancesOrder) EqualVT(that *ConfigureHistoricalBalancesOrder) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *ConfigureHistoricalBalancesOrder) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*ConfigureHistoricalBalancesOrder)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *LedgerApplyOrder_ConfigureHistoricalBalances) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *LedgerApplyOrder_ConfigureHistoricalBalances) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *ConfigureHistoricalBalancesOrder) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ConfigureHistoricalBalancesOrder) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ConfigureHistoricalBalancesOrder) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *LedgerApplyOrder_ConfigureHistoricalBalances) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConfigureHistoricalBalancesOrder) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LedgerApplyOrder) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			if oneof, ok := m.Data.(*LedgerApplyOrder_ConfigureHistoricalBalances); ok {
				if err := oneof.ConfigureHistoricalBalances.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &ConfigureHistoricalBalancesOrder{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Data = &LedgerApplyOrder_ConfigureHistoricalBalances{ConfigureHistoricalBalances: v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *ConfigureHistoricalBalancesOrder) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConfigureHistoricalBalancesOrder: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConfigureHistoricalBalancesOrder: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
