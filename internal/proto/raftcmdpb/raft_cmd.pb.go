...
var file_raft_cmd_proto_depIdxs = []int32{
	...
	112, // 114: raft.VolumePair.input_known:type_name -> common.Uint256
	112, // 115: raft.VolumePair.input_diff:type_name -> common.Uint256
	112, // 116: raft.VolumePair.output_known:type_name -> common.Uint256
	112, // 117: raft.VolumePair.output_diff:type_name -> common.Uint256
	61,  // 118: raft.PreloadSet.preloads:type_name -> raft.Preload
	62,  // 119: raft.Preload.volume:type_name -> raft.PreloadVolume
	63,  // 120: raft.Preload.idempotency_key:type_name -> raft.PreloadIdempotencyKey
	64,  // 121: raft.Preload.ledger:type_name -> raft.PreloadLedger
	65,  // 122: raft.Preload.boundary:type_name -> raft.PreloadBoundary
	66,  // 123: raft.Preload.transaction_reference:type_name -> raft.PreloadTransactionReference
	67,  // 124: raft.Preload.sink_config:type_name -> raft.PreloadSinkConfig
	68,  // 125: raft.Preload.account_metadata:type_name -> raft.PreloadAccountMetadata
	69,  // 126: raft.Preload.numscript_version:type_name -> raft.PreloadNumscriptVersion
	70,  // 127: raft.Preload.numscript_entry:type_name -> raft.PreloadNumscriptEntry
	81,  // 128: raft.PreloadVolume.id:type_name -> raft.AttributeID
	112, // 129: raft.PreloadVolume.input:type_name -> common.Uint256
	112, // 130: raft.PreloadVolume.output:type_name -> common.Uint256
	81,  // 131: raft.PreloadIdempotencyKey.id:type_name -> raft.AttributeID
	81,  // 132: raft.PreloadLedger.id:type_name -> raft.AttributeID
	86,  // 133: raft.PreloadLedger.info:type_name -> common.LedgerInfo
	81,  // 134: raft.PreloadBoundary.id:type_name -> raft.AttributeID
	58,  // 135: raft.PreloadBoundary.boundaries:type_name -> raft.LedgerBoundaries
	81,  // 136: raft.PreloadTransactionReference.id:type_name -> raft.AttributeID
	81,  // 137: raft.PreloadSinkConfig.id:type_name -> raft.AttributeID
	91,  // 138: raft.PreloadSinkConfig.config:type_name -> common.SinkConfig
	81,  // 139: raft.PreloadAccountMetadata.id:type_name -> raft.AttributeID
	107, // 140: raft.PreloadAccountMetadata.value:type_name -> common.MetadataValue
	81,  // 141: raft.PreloadNumscriptVersion.id:type_name -> raft.AttributeID
	81,  // 142: raft.PreloadNumscriptEntry.id:type_name -> raft.AttributeID
	74,  // 143: raft.MemorySnapshot.gen0:type_name -> raft.GenerationSnapshot
	74,  // 144: raft.MemorySnapshot.gen1:type_name -> raft.GenerationSnapshot
	113, // 145: raft.MemorySnapshot.open_period:type_name -> common.Period
	113, // 146: raft.MemorySnapshot.closing_period:type_name -> common.Period
	113, // 147: raft.MemorySnapshot.closed_periods:type_name -> common.Period
	80,  // 148: raft.MemorySnapshot.reversions:type_name -> raft.ReversionBitsetEntry
	73,  // 149: raft.NodeSnapshot.peer_addresses:type_name -> raft.PeerAddress
	75,  // 150: raft.GenerationSnapshot.volumes:type_name -> raft.VolumeAttributeSnapshotEntry
	76,  // 151: raft.GenerationSnapshot.metadata:type_name -> raft.MetadataAttributeEntry
	76,  // 152: raft.GenerationSnapshot.ledger_metadata:type_name -> raft.MetadataAttributeEntry
	77,  // 153: raft.GenerationSnapshot.ledgers:type_name -> raft.LedgerAttributeEntry
	78,  // 154: raft.GenerationSnapshot.boundaries:type_name -> raft.BoundaryAttributeEntry
	79,  // 155: raft.GenerationSnapshot.references:type_name -> raft.TransactionReferenceAttributeEntry
	81,  // 156: raft.VolumeAttributeSnapshotEntry.id:type_name -> raft.AttributeID
	112, // 157: raft.VolumeAttributeSnapshotEntry.input_known:type_name -> common.Uint256
	112, // 158: raft.VolumeAttributeSnapshotEntry.input_diff:type_name -> common.Uint256
	112, // 159: raft.VolumeAttributeSnapshotEntry.output_known:type_name -> common.Uint256
	112, // 160: raft.VolumeAttributeSnapshotEntry.output_diff:type_name -> common.Uint256
	81,  // 161: raft.MetadataAttributeEntry.id:type_name -> raft.AttributeID
	107, // 162: raft.MetadataAttributeEntry.value:type_name -> common.MetadataValue
	81,  // 163: raft.LedgerAttributeEntry.id:type_name -> raft.AttributeID
	86,  // 164: raft.LedgerAttributeEntry.info:type_name -> common.LedgerInfo
	81,  // 165: raft.BoundaryAttributeEntry.id:type_name -> raft.AttributeID
	58,  // 166: raft.BoundaryAttributeEntry.boundaries:type_name -> raft.LedgerBoundaries
	81,  // 167: raft.TransactionReferenceAttributeEntry.id:type_name -> raft.AttributeID
	114, // 168: raft.TransactionReferenceAttributeEntry.value:type_name -> common.TransactionReferenceValue
	0,   // 169: raft.State.LedgersEntry.value:type_name -> raft.LedgerState
	104, // 170: raft.CreateLedgerOrder.AccountTypesEntry.value:type_name -> common.AccountType
	98,  // 171: raft.MirrorCreatedTransaction.AccountMetadataEntry.value:type_name -> common.MetadataSet
	98,  // 172: raft.CreateTransactionOrder.AccountMetadataEntry.value:type_name -> common.MetadataSet
