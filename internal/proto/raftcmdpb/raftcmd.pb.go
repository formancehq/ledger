...
var file_raftcmd_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_raftcmd_proto_goTypes = []any{
	...
	(*ProgressInfo)(nil),                   // 16: raft.ProgressInfo
	(*RaftStatus)(nil),                     // 17: raft.RaftStatus
	(*ClusterState)(nil),                   // 18: raft.ClusterState
	nil,                                    // 19: raft.State.LedgersEntry
	nil,                                    // 20: raft.AppendTransactionCommand.MetadataEntry
	nil,                                    // 21: raft.AppendTransactionCommand.AccountMetadataEntry
	nil,                                    // 22: raft.CreateLedgerCommand.MetadataEntry
	nil,                                    // 23: raft.TransactionResume.MetadataEntry
	nil,                                    // 24: raft.CreatedTransactionMemento.AccountMetadataEntry
	nil,                                    // 25: raft.RaftStatus.ProgressEntry
	(*commonpb.LedgerInfo)(nil),            // 26: common.LedgerInfo
	(*commonpb.Posting)(nil),               // 27: common.Posting
	(*commonpb.Timestamp)(nil),             // 28: common.Timestamp
	(*commonpb.Transaction)(nil),           // 29: common.Transaction
	(*commonpb.SaveMetadataCommand)(nil),   // 30: common.SaveMetadataCommand
	(*commonpb.DeleteMetadataCommand)(nil), // 31: common.DeleteMetadataCommand
	(*commonpb.Idempotency)(nil),           // 32: common.Idempotency
	(*commonpb.Metadata)(nil),              // 33: common.Metadata
}
var file_raftcmd_proto_depIdxs = []int32{
	26, // 0: raft.LedgerState.ledger_info:type_name -> common.LedgerInfo
	19, // 1: raft.State.ledgers:type_name -> raft.State.LedgersEntry
	27, // 2: raft.AppendTransactionCommand.postings:type_name -> common.Posting
	20, // 3: raft.AppendTransactionCommand.metadata:type_name -> raft.AppendTransactionCommand.MetadataEntry
	28, // 4: raft.AppendTransactionCommand.timestamp:type_name -> common.Timestamp
	21, // 5: raft.AppendTransactionCommand.account_metadata:type_name -> raft.AppendTransactionCommand.AccountMetadataEntry
	29, // 6: raft.RevertTransactionCommand.revert_transaction:type_name -> common.Transaction
	3,  // 7: raft.CreateLedgerLogCommand.append_transaction:type_name -> raft.AppendTransactionCommand
	30, // 8: raft.CreateLedgerLogCommand.save_metadata:type_name -> common.SaveMetadataCommand
	31, // 9: raft.CreateLedgerLogCommand.delete_metadata:type_name -> common.DeleteMetadataCommand
	4,  // 10: raft.CreateLedgerLogCommand.revert_transaction:type_name -> raft.RevertTransactionCommand
	22, // 11: raft.CreateLedgerCommand.metadata:type_name -> raft.CreateLedgerCommand.MetadataEntry
	...
	32, // 15: raft.ActionData.idempotency:type_name -> common.Idempotency
	...
	28, // 19: raft.CommandBatch.date:type_name -> common.Timestamp
	27, // 20: raft.TransactionResume.postings:type_name -> common.Posting
	23, // 21: raft.TransactionResume.metadata:type_name -> raft.TransactionResume.MetadataEntry
	28, // 22: raft.TransactionResume.timestamp:type_name -> common.Timestamp
	12, // 23: raft.CreatedTransactionMemento.transaction:type_name -> raft.TransactionResume
	24, // 24: raft.CreatedTransactionMemento.account_metadata:type_name -> raft.CreatedTransactionMemento.AccountMetadataEntry
	12, // 25: raft.RevertedTransactionMemento.revert_transaction:type_name -> raft.TransactionResume
	25, // 26: raft.RaftStatus.progress:type_name -> raft.RaftStatus.ProgressEntry
	15, // 27: raft.ClusterState.nodes:type_name -> raft.NodeInfo
	17, // 28: raft.ClusterState.raft_status:type_name -> raft.RaftStatus
	2,  // 29: raft.ClusterState.inner_state:type_name -> raft.State
	1,  // 30: raft.State.LedgersEntry.value:type_name -> raft.LedgerState
	33, // 31: raft.AppendTransactionCommand.AccountMetadataEntry.value:type_name -> common.Metadata
	33, // 32: raft.CreatedTransactionMemento.AccountMetadataEntry.value:type_name -> common.Metadata
	16, // 33: raft.RaftStatus.ProgressEntry.value:type_name -> raft.ProgressInfo
