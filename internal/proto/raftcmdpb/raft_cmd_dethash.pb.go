...
func (m *MirrorLogEntry) MarshalToSizedBufferDeterministicVT(dAtA []byte) (int, error) {
	...
	case *MirrorLogEntry_SavedMetadata:
		if v.SavedMetadata != nil {
			size, _ := v.SavedMetadata.MarshalToSizedBufferVT(dAtA[:i])
			i -= size
			i = protohelpers.EncodeVarint(dAtA, i, uint64(size))
			i--
			dAtA[i] = 0x1a
	...
	case *MirrorLogEntry_RevertedTransaction:
		if v.RevertedTransaction != nil {
			size, _ := v.RevertedTransaction.MarshalToSizedBufferVT(dAtA[:i])
			i -= size
			i = protohelpers.EncodeVarint(dAtA, i, uint64(size))
			i--
			dAtA[i] = 0x22
...
func (m *Preload) MarshalToSizedBufferDeterministicVT(dAtA []byte) (int, error) {
	...
	case *Preload_NumscriptEntry:
		if v.NumscriptEntry != nil {
			size, _ := v.NumscriptEntry.MarshalToSizedBufferVT(dAtA[:i])
			i -= size
			i = protohelpers.EncodeVarint(dAtA, i, uint64(size))
			i--
			dAtA[i] = 0x4a
	...
	case *Preload_TransactionState:
		if v.TransactionState != nil {
			size, _ := v.TransactionState.MarshalToSizedBufferVT(dAtA[:i])
			i -= size
			i = protohelpers.EncodeVarint(dAtA, i, uint64(size))
			i--
			dAtA[i] = 0x52
		}
	case *Preload_NumscriptParsed:
		if v.NumscriptParsed != nil {
			size, _ := v.NumscriptParsed.MarshalToSizedBufferVT(dAtA[:i])
			i -= size
			i = protohelpers.EncodeVarint(dAtA, i, uint64(size))
			i--
			dAtA[i] = 0x5a
...
func (m *PreloadNumscriptEntry) MarshalDeterministicVT(dAtA []byte) []byte {
	if m == nil {
		return dAtA
	}
	b, err := m.MarshalVT()
...
func (m *PreloadNumscriptParsed) MarshalDeterministicVT(dAtA []byte) []byte {
	if m == nil {
		return dAtA
	}
	b, err := m.MarshalVT()
...
func (m *GenerationSnapshot) MarshalToSizedBufferDeterministicVT(dAtA []byte) (int, error) {
	...
	if len(m.NumscriptParsed) > 0 {
		for iNdEx := len(m.NumscriptParsed) - 1; iNdEx >= 0; iNdEx-- {
			size, _ := m.NumscriptParsed[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			i -= size
			i = protohelpers.EncodeVarint(dAtA, i, uint64(size))
			i--
			dAtA[i] = 0x4a
	...
	if len(m.Transactions) > 0 {
		for iNdEx := len(m.Transactions) - 1; iNdEx >= 0; iNdEx-- {
			size, _ := m.Transactions[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			i -= size
			i = protohelpers.EncodeVarint(dAtA, i, uint64(size))
			i--
			dAtA[i] = 0x42
...
func (m *NumscriptParsedAttributeEntry) MarshalDeterministicVT(dAtA []byte) []byte {
	if m == nil {
		return dAtA
	}
	b, err := m.MarshalVT()
