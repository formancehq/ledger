...
func (x *Action) GetApply() *LedgerApplyAction {
	if x != nil {
		if x, ok := x.Type.(*Action_Apply); ok {
			return x.Apply
		}
	}
	return nil
...
func (x *Action) GetCreateLedger() *CreateLedgerRequest {
	if x != nil {
		if x, ok := x.Type.(*Action_CreateLedger); ok {
...
func (x *Action) GetDeleteLedger() *DeleteLedgerRequest {
	if x != nil {
		if x, ok := x.Type.(*Action_DeleteLedger); ok {
...
func (*Action_CreateLedger) isAction_Type() {}

func (*Action_DeleteLedger) isAction_Type() {}
...
type LedgerApplyAction struct {
	...
	//	*LedgerApplyAction_AddMetadata
	//	*LedgerApplyAction_RevertTransaction
	//	*LedgerApplyAction_DeleteMetadata
	Data          isLedgerApplyAction_Data `protobuf_oneof:"data"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LedgerApplyAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *LedgerApplyAction) GetCreateTransaction() *CreateTransactionPayload {
	if x != nil {
		if x, ok := x.Data.(*LedgerApplyAction_CreateTransaction); ok {
...
func (x *LedgerApplyAction) GetAddMetadata() *commonpb.SaveMetadataCommand {
	if x != nil {
		if x, ok := x.Data.(*LedgerApplyAction_AddMetadata); ok {
...
func (x *LedgerApplyAction) GetRevertTransaction() *RevertTransactionPayload {
	if x != nil {
		if x, ok := x.Data.(*LedgerApplyAction_RevertTransaction); ok {
...
func (x *LedgerApplyAction) GetDeleteMetadata() *commonpb.DeleteMetadataCommand {
	if x != nil {
		if x, ok := x.Data.(*LedgerApplyAction_DeleteMetadata); ok {
...
type isLedgerApplyAction_Data interface {
	isLedgerApplyAction_Data()
}
...
func (*LedgerApplyAction_AddMetadata) isLedgerApplyAction_Data() {}

func (*LedgerApplyAction_RevertTransaction) isLedgerApplyAction_Data() {}

func (*LedgerApplyAction_DeleteMetadata) isLedgerApplyAction_Data() {}
...
const file_service_proto_rawDesc = "" +
	"\n" +
	"\rservice.proto\x12\x06ledger\x1a\fcommon.proto\x1a\rraftcmd.proto\"]\n" +
	...
	"\ftables_moved\x18\x0e \x01(\x04R\vtablesMoved2\x99\x05\n" +
	"\rLedgerService\x12P\n" +
	"\x11GetAllLedgersInfo\x12\x1c.ledger.GetAllLedgersRequest\x1a\x1d.ledger.GetAllLedgersResponse\x12E\n" +
	"\x0fGetLedgerByName\x12\x1e.ledger.GetLedgerByNameRequest\x1a\x12.common.LedgerInfo\x128\n" +
	"\n" +
	...
	"\x0fGetClusterState\x12\x1e.ledger.GetClusterStateRequest\x1a\x12.raft.ClusterStateB>Z<github.com/formancehq/ledger-v3-poc/internal/proto/servicepbb\x06proto3"
...
var file_service_proto_goTypes = []any{
	...
	(*StreamLedgerLogsRequest)(nil),        // 2: ledger.StreamLedgerLogsRequest
	(*StreamLedgerLogsResponse)(nil),       // 3: ledger.StreamLedgerLogsResponse
	...
	(*GetAllLedgersResponse)(nil),          // 10: ledger.GetAllLedgersResponse
	(*GetLedgerByNameRequest)(nil),         // 11: ledger.GetLedgerByNameRequest
	(*GetClusterStateRequest)(nil),         // 12: ledger.GetClusterStateRequest
	(*ApplyRequest)(nil),                   // 13: ledger.ApplyRequest
	(*ApplyResponse)(nil),                  // 14: ledger.ApplyResponse
	(*Action)(nil),                         // 15: ledger.Action
	...
	(*LedgerNameOrId)(nil),                 // 18: ledger.LedgerNameOrId
	(*LedgerApplyAction)(nil),              // 19: ledger.LedgerApplyAction
	(*GetStoreMetricsRequest)(nil),         // 20: ledger.GetStoreMetricsRequest
	(*GetStoreMetricsResponse)(nil),        // 21: ledger.GetStoreMetricsResponse
	(*PebbleMetrics)(nil),                  // 22: ledger.PebbleMetrics
	(*BlockCacheMetrics)(nil),              // 23: ledger.BlockCacheMetrics
	(*CompactMetrics)(nil),                 // 24: ledger.CompactMetrics
	(*FlushMetrics)(nil),                   // 25: ledger.FlushMetrics
	(*MemTableMetrics)(nil),                // 26: ledger.MemTableMetrics
	(*SnapshotsMetrics)(nil),               // 27: ledger.SnapshotsMetrics
	(*TableMetrics)(nil),                   // 28: ledger.TableMetrics
	(*TableCacheMetrics)(nil),              // 29: ledger.TableCacheMetrics
	(*WALMetrics)(nil),                     // 30: ledger.WALMetrics
	(*KeysMetrics)(nil),                    // 31: ledger.KeysMetrics
	(*LevelMetrics)(nil),                   // 32: ledger.LevelMetrics
	nil,                                    // 33: ledger.CreateLedgerRequest.MetadataEntry
	nil,                                    // 34: ledger.GetAllLedgersResponse.LedgersEntry
	nil,                                    // 35: ledger.CreateTransactionPayload.MetadataEntry
	nil,                                    // 36: ledger.CreateTransactionPayload.AccountMetadataEntry
	nil,                                    // 37: ledger.RevertTransactionPayload.MetadataEntry
	(*commonpb.LedgerLog)(nil),             // 38: common.LedgerLog
	...
	(*commonpb.SaveMetadataCommand)(nil),   // 43: common.SaveMetadataCommand
	(*commonpb.DeleteMetadataCommand)(nil), // 44: common.DeleteMetadataCommand
	(*commonpb.LedgerInfo)(nil),            // 45: common.LedgerInfo
	(*commonpb.Metadata)(nil),              // 46: common.Metadata
	(*commonpb.Account)(nil),               // 47: common.Account
	(*commonpb.Transaction)(nil),           // 48: common.Transaction
	(*raftcmdpb.ClusterState)(nil),         // 49: raft.ClusterState
}
var file_service_proto_depIdxs = []int32{
	18, // 0: ledger.GetAccountRequest.ledger:type_name -> ledger.LedgerNameOrId
	18, // 1: ledger.GetTransactionRequest.ledger:type_name -> ledger.LedgerNameOrId
	38, // 2: ledger.StreamLedgerLogsResponse.log:type_name -> common.LedgerLog
	39, // 3: ledger.StreamLogsResponse.log:type_name -> common.Log
	33, // 4: ledger.CreateLedgerRequest.metadata:type_name -> ledger.CreateLedgerRequest.MetadataEntry
	34, // 5: ledger.GetAllLedgersResponse.ledgers:type_name -> ledger.GetAllLedgersResponse.LedgersEntry
	15, // 6: ledger.ApplyRequest.actions:type_name -> ledger.Action
	39, // 7: ledger.ApplyResponse.logs:type_name -> common.Log
	19, // 8: ledger.Action.apply:type_name -> ledger.LedgerApplyAction
	6,  // 9: ledger.Action.create_ledger:type_name -> ledger.CreateLedgerRequest
	7,  // 10: ledger.Action.delete_ledger:type_name -> ledger.DeleteLedgerRequest
	40, // 11: ledger.CreateTransactionPayload.postings:type_name -> common.Posting
	41, // 12: ledger.CreateTransactionPayload.script:type_name -> common.Script
	42, // 13: ledger.CreateTransactionPayload.timestamp:type_name -> common.Timestamp
	35, // 14: ledger.CreateTransactionPayload.metadata:type_name -> ledger.CreateTransactionPayload.MetadataEntry
	36, // 15: ledger.CreateTransactionPayload.account_metadata:type_name -> ledger.CreateTransactionPayload.AccountMetadataEntry
	37, // 16: ledger.RevertTransactionPayload.metadata:type_name -> ledger.RevertTransactionPayload.MetadataEntry
	18, // 17: ledger.LedgerApplyAction.ledger:type_name -> ledger.LedgerNameOrId
	16, // 18: ledger.LedgerApplyAction.create_transaction:type_name -> ledger.CreateTransactionPayload
	43, // 19: ledger.LedgerApplyAction.add_metadata:type_name -> common.SaveMetadataCommand
	17, // 20: ledger.LedgerApplyAction.revert_transaction:type_name -> ledger.RevertTransactionPayload
	44, // 21: ledger.LedgerApplyAction.delete_metadata:type_name -> common.DeleteMetadataCommand
	22, // 22: ledger.GetStoreMetricsResponse.metrics:type_name -> ledger.PebbleMetrics
	23, // 23: ledger.PebbleMetrics.block_cache:type_name -> ledger.BlockCacheMetrics
	24, // 24: ledger.PebbleMetrics.compact:type_name -> ledger.CompactMetrics
	25, // 25: ledger.PebbleMetrics.flush:type_name -> ledger.FlushMetrics
	26, // 26: ledger.PebbleMetrics.mem_table:type_name -> ledger.MemTableMetrics
	27, // 27: ledger.PebbleMetrics.snapshots:type_name -> ledger.SnapshotsMetrics
	28, // 28: ledger.PebbleMetrics.table:type_name -> ledger.TableMetrics
	29, // 29: ledger.PebbleMetrics.table_cache:type_name -> ledger.TableCacheMetrics
	30, // 30: ledger.PebbleMetrics.wal:type_name -> ledger.WALMetrics
	31, // 31: ledger.PebbleMetrics.keys:type_name -> ledger.KeysMetrics
	32, // 32: ledger.PebbleMetrics.levels:type_name -> ledger.LevelMetrics
	45, // 33: ledger.GetAllLedgersResponse.LedgersEntry.value:type_name -> common.LedgerInfo
	46, // 34: ledger.CreateTransactionPayload.AccountMetadataEntry.value:type_name -> common.Metadata
	9,  // 35: ledger.LedgerService.GetAllLedgersInfo:input_type -> ledger.GetAllLedgersRequest
	11, // 36: ledger.LedgerService.GetLedgerByName:input_type -> ledger.GetLedgerByNameRequest
	...
	2,  // 39: ledger.LedgerService.StreamLedgerLogs:input_type -> ledger.StreamLedgerLogsRequest
	4,  // 40: ledger.LedgerService.StreamLogs:input_type -> ledger.StreamLogsRequest
	13, // 41: ledger.LedgerService.Apply:input_type -> ledger.ApplyRequest
	20, // 42: ledger.LedgerService.GetStoreMetrics:input_type -> ledger.GetStoreMetricsRequest
	12, // 43: ledger.LedgerService.GetClusterState:input_type -> ledger.GetClusterStateRequest
	10, // 44: ledger.LedgerService.GetAllLedgersInfo:output_type -> ledger.GetAllLedgersResponse
	45, // 45: ledger.LedgerService.GetLedgerByName:output_type -> common.LedgerInfo
	47, // 46: ledger.LedgerService.GetAccount:output_type -> common.Account
	48, // 47: ledger.LedgerService.GetTransaction:output_type -> common.Transaction
	3,  // 48: ledger.LedgerService.StreamLedgerLogs:output_type -> ledger.StreamLedgerLogsResponse
	5,  // 49: ledger.LedgerService.StreamLogs:output_type -> ledger.StreamLogsResponse
	14, // 50: ledger.LedgerService.Apply:output_type -> ledger.ApplyResponse
	21, // 51: ledger.LedgerService.GetStoreMetrics:output_type -> ledger.GetStoreMetricsResponse
	49, // 52: ledger.LedgerService.GetClusterState:output_type -> raft.ClusterState
...
func file_service_proto_init() {
	...
	file_service_proto_msgTypes[19].OneofWrappers = []any{
		...
		(*LedgerApplyAction_DeleteMetadata)(nil),
	}
	type x struct{}
