...
const file_service_proto_rawDesc = "" +
	...
	"\ftables_moved\x18\x0e \x01(\x04R\vtablesMoved2\x98\x04\n" +
	"\rLedgerService\x12P\n" +
...
var file_service_proto_goTypes = []any{
	...
	(*commonpb.LedgerLog)(nil),             // 36: common.LedgerLog
	(*commonpb.Log)(nil),                   // 37: common.Log
	(*commonpb.Posting)(nil),               // 38: common.Posting
	(*commonpb.Script)(nil),                // 39: common.Script
	(*commonpb.Timestamp)(nil),             // 40: common.Timestamp
	(*commonpb.SaveMetadataCommand)(nil),   // 41: common.SaveMetadataCommand
	(*commonpb.DeleteMetadataCommand)(nil), // 42: common.DeleteMetadataCommand
	(*commonpb.LedgerInfo)(nil),            // 43: common.LedgerInfo
	(*commonpb.Metadata)(nil),              // 44: common.Metadata
	(*commonpb.Transaction)(nil),           // 45: common.Transaction
}
var file_service_proto_depIdxs = []int32{
	36, // 0: ledger.StreamLedgerLogsResponse.log:type_name -> common.LedgerLog
	37, // 1: ledger.StreamLogsResponse.log:type_name -> common.Log
	31, // 2: ledger.CreateLedgerRequest.metadata:type_name -> ledger.CreateLedgerRequest.MetadataEntry
	32, // 3: ledger.GetAllLedgersResponse.ledgers:type_name -> ledger.GetAllLedgersResponse.LedgersEntry
	13, // 4: ledger.ApplyRequest.actions:type_name -> ledger.Action
	37, // 5: ledger.ApplyResponse.logs:type_name -> common.Log
	17, // 6: ledger.Action.apply:type_name -> ledger.LedgerApplyAction
	...
	38, // 9: ledger.CreateTransactionPayload.postings:type_name -> common.Posting
	39, // 10: ledger.CreateTransactionPayload.script:type_name -> common.Script
	40, // 11: ledger.CreateTransactionPayload.timestamp:type_name -> common.Timestamp
	33, // 12: ledger.CreateTransactionPayload.metadata:type_name -> ledger.CreateTransactionPayload.MetadataEntry
	34, // 13: ledger.CreateTransactionPayload.account_metadata:type_name -> ledger.CreateTransactionPayload.AccountMetadataEntry
	35, // 14: ledger.RevertTransactionPayload.metadata:type_name -> ledger.RevertTransactionPayload.MetadataEntry
	16, // 15: ledger.LedgerApplyAction.ledger:type_name -> ledger.LedgerNameOrId
	14, // 16: ledger.LedgerApplyAction.create_transaction:type_name -> ledger.CreateTransactionPayload
	41, // 17: ledger.LedgerApplyAction.add_metadata:type_name -> common.SaveMetadataCommand
	15, // 18: ledger.LedgerApplyAction.revert_transaction:type_name -> ledger.RevertTransactionPayload
	42, // 19: ledger.LedgerApplyAction.delete_metadata:type_name -> common.DeleteMetadataCommand
	20, // 20: ledger.GetStoreMetricsResponse.metrics:type_name -> ledger.PebbleMetrics
	21, // 21: ledger.PebbleMetrics.block_cache:type_name -> ledger.BlockCacheMetrics
	22, // 22: ledger.PebbleMetrics.compact:type_name -> ledger.CompactMetrics
	23, // 23: ledger.PebbleMetrics.flush:type_name -> ledger.FlushMetrics
	24, // 24: ledger.PebbleMetrics.mem_table:type_name -> ledger.MemTableMetrics
	25, // 25: ledger.PebbleMetrics.snapshots:type_name -> ledger.SnapshotsMetrics
	26, // 26: ledger.PebbleMetrics.table:type_name -> ledger.TableMetrics
	27, // 27: ledger.PebbleMetrics.table_cache:type_name -> ledger.TableCacheMetrics
	28, // 28: ledger.PebbleMetrics.wal:type_name -> ledger.WALMetrics
	29, // 29: ledger.PebbleMetrics.keys:type_name -> ledger.KeysMetrics
	30, // 30: ledger.PebbleMetrics.levels:type_name -> ledger.LevelMetrics
	43, // 31: ledger.GetAllLedgersResponse.LedgersEntry.value:type_name -> common.LedgerInfo
	44, // 32: ledger.CreateTransactionPayload.AccountMetadataEntry.value:type_name -> common.Metadata
	8,  // 33: ledger.LedgerService.GetAllLedgersInfo:input_type -> ledger.GetAllLedgersRequest
	10, // 34: ledger.LedgerService.GetLedgerByName:input_type -> ledger.GetLedgerByNameRequest
	0,  // 35: ledger.LedgerService.GetTransaction:input_type -> ledger.GetTransactionRequest
	1,  // 36: ledger.LedgerService.StreamLedgerLogs:input_type -> ledger.StreamLedgerLogsRequest
	3,  // 37: ledger.LedgerService.StreamLogs:input_type -> ledger.StreamLogsRequest
	11, // 38: ledger.LedgerService.Apply:input_type -> ledger.ApplyRequest
	18, // 39: ledger.LedgerService.GetStoreMetrics:input_type -> ledger.GetStoreMetricsRequest
	9,  // 40: ledger.LedgerService.GetAllLedgersInfo:output_type -> ledger.GetAllLedgersResponse
	43, // 41: ledger.LedgerService.GetLedgerByName:output_type -> common.LedgerInfo
	45, // 42: ledger.LedgerService.GetTransaction:output_type -> common.Transaction
	2,  // 43: ledger.LedgerService.StreamLedgerLogs:output_type -> ledger.StreamLedgerLogsResponse
	4,  // 44: ledger.LedgerService.StreamLogs:output_type -> ledger.StreamLogsResponse
	12, // 45: ledger.LedgerService.Apply:output_type -> ledger.ApplyResponse
	19, // 46: ledger.LedgerService.GetStoreMetrics:output_type -> ledger.GetStoreMetricsResponse
