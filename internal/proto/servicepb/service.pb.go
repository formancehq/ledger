...
const file_service_proto_rawDesc = "" +
	...
	"\ftables_moved\x18\x0e \x01(\x04R\vtablesMoved2\xd2\x04\n" +
	"\rLedgerService\x12P\n" +
	...
	"\x0fGetStoreMetrics\x12\x1e.ledger.GetStoreMetricsRequest\x1a\x1f.ledger.GetStoreMetricsResponseB>Z<github.com/formancehq/ledger-v3-poc/internal/proto/servicepbb\x06proto3"
...
var file_service_proto_goTypes = []any{
	...
	(*LedgerApplyAction)(nil),              // 18: ledger.LedgerApplyAction
	...
	nil,                                    // 32: ledger.CreateLedgerRequest.MetadataEntry
	nil,                                    // 33: ledger.GetAllLedgersResponse.LedgersEntry
	nil,                                    // 34: ledger.CreateTransactionPayload.MetadataEntry
	nil,                                    // 35: ledger.CreateTransactionPayload.AccountMetadataEntry
	nil,                                    // 36: ledger.RevertTransactionPayload.MetadataEntry
	(*commonpb.LedgerLog)(nil),             // 37: common.LedgerLog
	(*commonpb.Log)(nil),                   // 38: common.Log
	(*commonpb.Posting)(nil),               // 39: common.Posting
	(*commonpb.Script)(nil),                // 40: common.Script
	(*commonpb.Timestamp)(nil),             // 41: common.Timestamp
	(*commonpb.SaveMetadataCommand)(nil),   // 42: common.SaveMetadataCommand
	(*commonpb.DeleteMetadataCommand)(nil), // 43: common.DeleteMetadataCommand
	(*commonpb.LedgerInfo)(nil),            // 44: common.LedgerInfo
	(*commonpb.Metadata)(nil),              // 45: common.Metadata
	(*commonpb.Account)(nil),               // 46: common.Account
	(*commonpb.Transaction)(nil),           // 47: common.Transaction
}
var file_service_proto_depIdxs = []int32{
	...
	37, // 2: ledger.StreamLedgerLogsResponse.log:type_name -> common.LedgerLog
	38, // 3: ledger.StreamLogsResponse.log:type_name -> common.Log
	32, // 4: ledger.CreateLedgerRequest.metadata:type_name -> ledger.CreateLedgerRequest.MetadataEntry
	33, // 5: ledger.GetAllLedgersResponse.ledgers:type_name -> ledger.GetAllLedgersResponse.LedgersEntry
	14, // 6: ledger.ApplyRequest.actions:type_name -> ledger.Action
	38, // 7: ledger.ApplyResponse.logs:type_name -> common.Log
	18, // 8: ledger.Action.apply:type_name -> ledger.LedgerApplyAction
	...
	39, // 11: ledger.CreateTransactionPayload.postings:type_name -> common.Posting
	40, // 12: ledger.CreateTransactionPayload.script:type_name -> common.Script
	41, // 13: ledger.CreateTransactionPayload.timestamp:type_name -> common.Timestamp
	34, // 14: ledger.CreateTransactionPayload.metadata:type_name -> ledger.CreateTransactionPayload.MetadataEntry
	35, // 15: ledger.CreateTransactionPayload.account_metadata:type_name -> ledger.CreateTransactionPayload.AccountMetadataEntry
	36, // 16: ledger.RevertTransactionPayload.metadata:type_name -> ledger.RevertTransactionPayload.MetadataEntry
	17, // 17: ledger.LedgerApplyAction.ledger:type_name -> ledger.LedgerNameOrId
	15, // 18: ledger.LedgerApplyAction.create_transaction:type_name -> ledger.CreateTransactionPayload
	42, // 19: ledger.LedgerApplyAction.add_metadata:type_name -> common.SaveMetadataCommand
	16, // 20: ledger.LedgerApplyAction.revert_transaction:type_name -> ledger.RevertTransactionPayload
	43, // 21: ledger.LedgerApplyAction.delete_metadata:type_name -> common.DeleteMetadataCommand
	21, // 22: ledger.GetStoreMetricsResponse.metrics:type_name -> ledger.PebbleMetrics
	22, // 23: ledger.PebbleMetrics.block_cache:type_name -> ledger.BlockCacheMetrics
	23, // 24: ledger.PebbleMetrics.compact:type_name -> ledger.CompactMetrics
	24, // 25: ledger.PebbleMetrics.flush:type_name -> ledger.FlushMetrics
	25, // 26: ledger.PebbleMetrics.mem_table:type_name -> ledger.MemTableMetrics
	26, // 27: ledger.PebbleMetrics.snapshots:type_name -> ledger.SnapshotsMetrics
	27, // 28: ledger.PebbleMetrics.table:type_name -> ledger.TableMetrics
	28, // 29: ledger.PebbleMetrics.table_cache:type_name -> ledger.TableCacheMetrics
	29, // 30: ledger.PebbleMetrics.wal:type_name -> ledger.WALMetrics
	30, // 31: ledger.PebbleMetrics.keys:type_name -> ledger.KeysMetrics
	31, // 32: ledger.PebbleMetrics.levels:type_name -> ledger.LevelMetrics
	44, // 33: ledger.GetAllLedgersResponse.LedgersEntry.value:type_name -> common.LedgerInfo
	45, // 34: ledger.CreateTransactionPayload.AccountMetadataEntry.value:type_name -> common.Metadata
	...
	12, // 41: ledger.LedgerService.Apply:input_type -> ledger.ApplyRequest
	19, // 42: ledger.LedgerService.GetStoreMetrics:input_type -> ledger.GetStoreMetricsRequest
	10, // 43: ledger.LedgerService.GetAllLedgersInfo:output_type -> ledger.GetAllLedgersResponse
	44, // 44: ledger.LedgerService.GetLedgerByName:output_type -> common.LedgerInfo
	46, // 45: ledger.LedgerService.GetAccount:output_type -> common.Account
	47, // 46: ledger.LedgerService.GetTransaction:output_type -> common.Transaction
	3,  // 47: ledger.LedgerService.StreamLedgerLogs:output_type -> ledger.StreamLedgerLogsResponse
	5,  // 48: ledger.LedgerService.StreamLogs:output_type -> ledger.StreamLogsResponse
	13, // 49: ledger.LedgerService.Apply:output_type -> ledger.ApplyResponse
	20, // 50: ledger.LedgerService.GetStoreMetrics:output_type -> ledger.GetStoreMetricsResponse
