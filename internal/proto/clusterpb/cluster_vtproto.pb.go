...
func (m *GetFSMDigestRequest) CloneVT() *GetFSMDigestRequest {
	if m == nil {
		return (*GetFSMDigestRequest)(nil)
	}
	r := new(GetFSMDigestRequest)
	r.Index = m.Index
	r.WaitMs = m.WaitMs
...
func (m *GetFSMDigestRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *FSMDigest) CloneVT() *FSMDigest {
	if m == nil {
		return (*FSMDigest)(nil)
	}
	r := new(FSMDigest)
	r.AppliedIndex = m.AppliedIndex
	r.SnapshotIndex = m.SnapshotIndex
	r.NodeId = m.NodeId
...
func (m *FSMDigest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *GetFSMDigestRequest) EqualVT(that *GetFSMDigestRequest) bool {
	if this == that {
		return true
	...
	if this.WaitMs != that.WaitMs {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}

func (this *GetFSMDigestRequest) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*GetFSMDigestRequest)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *FSMDigest) EqualVT(that *FSMDigest) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if string(this.Digest) != string(that.Digest) {
		return false
	}
...
func (this *FSMDigest) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*FSMDigest)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *GetFSMDigestRequest) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *GetFSMDigestRequest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *GetFSMDigestRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.WaitMs != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.WaitMs))
		i--
		dAtA[i] = 0x10
	}
	if m.Index != 0 {
		i -= 8
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(m.Index))
		i--
		dAtA[i] = 0x9
	}
...
func (m *FSMDigest) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FSMDigest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FSMDigest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.SnapshotIndex != 0 {
		i -= 8
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(m.SnapshotIndex))
		i--
		dAtA[i] = 0x11
	}
	if m.AppliedIndex != 0 {
...
func (m *GetFSMDigestRequest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.WaitMs != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.WaitMs))
	}
	n += len(m.unknownFields)
	return n
}

func (m *FSMDigest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetFSMDigestRequest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: GetFSMDigestRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetFSMDigestRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 1 {
			...
			m.Index = uint64(binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
		case 2:
			if wireType != 0 {
...
func (m *FSMDigest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FSMDigest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FSMDigest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 1 {
		...
		case 2:
			...
			m.SnapshotIndex = uint64(binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
		case 3:
			if wireType != 2 {
