...
const file_cluster_proto_rawDesc = "" +
	"\n" +
	"\rcluster.proto\x12\acluster\"\x18\n" +
	"\x16GetClusterStateRequest\"P\n" +
	"\bNodeInfo\x12\x0e\n" +
	...
	"\x0fGetClusterState\x12\x1f.cluster.GetClusterStateRequest\x1a\x15.cluster.ClusterStateB>Z<github.com/formancehq/ledger-v3-poc/internal/proto/clusterpbb\x06proto3"
...
var file_cluster_proto_goTypes = []any{
	...
	nil,                            // 5: cluster.RaftStatus.ProgressEntry
}
var file_cluster_proto_depIdxs = []int32{
	5, // 0: cluster.RaftStatus.progress:type_name -> cluster.RaftStatus.ProgressEntry
	1, // 1: cluster.ClusterState.nodes:type_name -> cluster.NodeInfo
	3, // 2: cluster.ClusterState.raft_status:type_name -> cluster.RaftStatus
	2, // 3: cluster.RaftStatus.ProgressEntry.value:type_name -> cluster.ProgressInfo
	0, // 4: cluster.ClusterService.GetClusterState:input_type -> cluster.GetClusterStateRequest
	4, // 5: cluster.ClusterService.GetClusterState:output_type -> cluster.ClusterState
