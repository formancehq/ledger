...
var file_common_proto_goTypes = []any{
	...
	(*descriptorpb.MethodOptions)(nil),               // 199: google.protobuf.MethodOptions
	(*descriptorpb.FieldOptions)(nil),                // 200: google.protobuf.FieldOptions
}
var file_common_proto_depIdxs = []int32{
	...
	198, // 43: common.Log.response_signature:type_name -> signature.SignedLog
	...
	189, // 126: common.OrderSkippedLog.context:type_name -> common.OrderSkippedLog.ContextEntry
	...
	190, // 131: common.CreatedTransaction.account_metadata:type_name -> common.CreatedTransaction.AccountMetadataEntry
	...
	191, // 134: common.SavedMetadata.metadata:type_name -> common.SavedMetadata.MetadataEntry
	...
	192, // 184: common.LedgerInfo.account_types:type_name -> common.LedgerInfo.AccountTypesEntry
	12,  // 185: common.LedgerInfo.default_enforcement_mode:type_name -> common.ChartEnforcementMode
	193, // 186: common.LedgerInfo.metadata:type_name -> common.LedgerInfo.MetadataEntry
	38,  // 187: common.SaveMetadataCommand.target:type_name -> common.Target
	194, // 188: common.SaveMetadataCommand.metadata:type_name -> common.SaveMetadataCommand.MetadataEntry
	38,  // 189: common.DeleteMetadataCommand.target:type_name -> common.Target
	195, // 190: common.TransactionState.metadata:type_name -> common.TransactionState.MetadataEntry
	...
	196, // 196: common.IdempotencyFailure.metadata:type_name -> common.IdempotencyFailure.MetadataEntry
	...
	197, // 201: common.AccountType.segment_types:type_name -> common.AccountType.SegmentTypesEntry
	...
	168, // 247: common.AuthenticatedCaller.identity:type_name -> common.CallerIdentity
	169, // 248: common.CallerSnapshot.authenticated:type_name -> common.AuthenticatedCaller
	170, // 249: common.CallerSnapshot.anonymous:type_name -> common.AnonymousCaller
	171, // 250: common.CallerSnapshot.system:type_name -> common.SystemCaller
	172, // 251: common.CallerSnapshot.auth_disabled:type_name -> common.AuthDisabledCaller
	174, // 252: common.BackupStorage.s3:type_name -> common.S3StorageConfig
	175, // 253: common.BackupStorage.azure:type_name -> common.AzureStorageConfig
	177, // 254: common.ListOptions.read:type_name -> common.ReadOptions
	141, // 255: common.ListOptions.filter:type_name -> common.QueryFilter
	21,  // 256: common.MetadataMap.ValuesEntry.value:type_name -> common.MetadataValue
	21,  // 257: common.Transaction.MetadataEntry.value:type_name -> common.MetadataValue
	32,  // 258: common.PostCommitVolumes.VolumesByAccountEntry.value:type_name -> common.VolumesByAssets
	21,  // 259: common.Account.MetadataEntry.value:type_name -> common.MetadataValue
	39,  // 260: common.MetadataSchema.AccountFieldsEntry.value:type_name -> common.MetadataFieldSchema
	39,  // 261: common.MetadataSchema.TransactionFieldsEntry.value:type_name -> common.MetadataFieldSchema
	39,  // 262: common.MetadataSchema.LedgerFieldsEntry.value:type_name -> common.MetadataFieldSchema
	21,  // 263: common.SavedLedgerMetadataLog.MetadataEntry.value:type_name -> common.MetadataValue
	137, // 264: common.CreatedLedgerLog.AccountTypesEntry.value:type_name -> common.AccountType
	22,  // 265: common.CreatedTransaction.AccountMetadataEntry.value:type_name -> common.MetadataMap
	21,  // 266: common.SavedMetadata.MetadataEntry.value:type_name -> common.MetadataValue
	137, // 267: common.LedgerInfo.AccountTypesEntry.value:type_name -> common.AccountType
	21,  // 268: common.LedgerInfo.MetadataEntry.value:type_name -> common.MetadataValue
	21,  // 269: common.SaveMetadataCommand.MetadataEntry.value:type_name -> common.MetadataValue
	21,  // 270: common.TransactionState.MetadataEntry.value:type_name -> common.MetadataValue
	133, // 271: common.AccountType.SegmentTypesEntry.value:type_name -> common.SegmentType
	199, // 272: common.auth_policy:extendee -> google.protobuf.MethodOptions
	200, // 273: common.allowed_query_targets:extendee -> google.protobuf.FieldOptions
	200, // 274: common.valid_on_no_query_target:extendee -> google.protobuf.FieldOptions
	200, // 275: common.ledger_log_is_history:extendee -> google.protobuf.FieldOptions
	18,  // 276: common.auth_policy:type_name -> common.MethodAuthPolicy
	16,  // 277: common.allowed_query_targets:type_name -> common.QueryTarget
	278, // [278:278] is the sub-list for method output_type
	278, // [278:278] is the sub-list for method input_type
	276, // [276:278] is the sub-list for extension type_name
	272, // [272:276] is the sub-list for extension extendee
