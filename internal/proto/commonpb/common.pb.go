...
// When set on an account type, variable segments are stored in compact binary
// form instead of UTF-8 strings, reducing key size and improving performance.
type SegmentValueType int32

const (
	SegmentValueType_SEGMENT_VALUE_STRING SegmentValueType = 0 // Default: length-prefixed UTF-8 string
	SegmentValueType_SEGMENT_VALUE_UUID   SegmentValueType = 1 // 16 bytes raw, RFC 4122 canonical form
	SegmentValueType_SEGMENT_VALUE_UINT64 SegmentValueType = 2 // 8 bytes big-endian
	SegmentValueType_SEGMENT_VALUE_BYTES  SegmentValueType = 3 // Length-prefixed raw bytes (hex-encoded in addresses)
)

// Enum value maps for SegmentValueType.
var (
	SegmentValueType_name = map[int32]string{
		0: "SEGMENT_VALUE_STRING",
		1: "SEGMENT_VALUE_UUID",
		2: "SEGMENT_VALUE_UINT64",
		3: "SEGMENT_VALUE_BYTES",
	}
	SegmentValueType_value = map[string]int32{
		"SEGMENT_VALUE_STRING": 0,
		"SEGMENT_VALUE_UUID":   1,
		"SEGMENT_VALUE_UINT64": 2,
		"SEGMENT_VALUE_BYTES":  3,
	}
)

func (x SegmentValueType) Enum() *SegmentValueType {
	p := new(SegmentValueType)
	*p = x
	return p
}

func (x SegmentValueType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SegmentValueType) Descriptor() protoreflect.EnumDescriptor {
	return file_common_proto_enumTypes[13].Descriptor()
}

func (SegmentValueType) Type() protoreflect.EnumType {
	return &file_common_proto_enumTypes[13]
}

func (x SegmentValueType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SegmentValueType.Descriptor instead.
func (SegmentValueType) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	AccountTypeStatus_ACCOUNT_TYPE_MIGRATING  AccountTypeStatus = 1 // Pattern migration in progress
...
type LedgerLogPayload struct {
	...
	//	*LedgerLogPayload_StartedAccountMigration
	//	*LedgerLogPayload_AccountMigrationBatch
	//	*LedgerLogPayload_CompletedAccountMigration
...
func (x *LedgerLogPayload) GetStartedAccountMigration() *StartedAccountMigrationLog {
	if x != nil {
		if x, ok := x.Payload.(*LedgerLogPayload_StartedAccountMigration); ok {
			return x.StartedAccountMigration
		}
	}
	return nil
}

func (x *LedgerLogPayload) GetAccountMigrationBatch() *AccountMigrationBatchLog {
	if x != nil {
		if x, ok := x.Payload.(*LedgerLogPayload_AccountMigrationBatch); ok {
...
func (x *LedgerLogPayload) GetCompletedAccountMigration() *CompletedAccountMigrationLog {
	if x != nil {
		if x, ok := x.Payload.(*LedgerLogPayload_CompletedAccountMigration); ok {
			return x.CompletedAccountMigration
		}
	}
	return nil
}
...
func (*LedgerLogPayload_StartedAccountMigration) isLedgerLogPayload_Payload() {}

func (*LedgerLogPayload_AccountMigrationBatch) isLedgerLogPayload_Payload() {}

func (*LedgerLogPayload_CompletedAccountMigration) isLedgerLogPayload_Payload() {}
...
type AccountType struct {
	...
	SegmentTypes  map[string]SegmentValueType `protobuf:"bytes,6,rep,name=segment_types,json=segmentTypes,proto3" json:"segment_types,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value,enum=common.SegmentValueType"` // variable_name -> encoding type
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AccountType) GetMigration() *AccountTypeMigration {
	if x != nil {
		return x.Migration
	}
	return nil
...
func (x *AccountType) GetSegmentTypes() map[string]SegmentValueType {
	if x != nil {
...
// AccountTypeMigration tracks the progress of a pattern migration or re-encoding.
type AccountTypeMigration struct {
	state              protoimpl.MessageState      `protogen:"open.v1"`
	TargetPattern      string                      `protobuf:"bytes,1,opt,name=target_pattern,json=targetPattern,proto3" json:"target_pattern,omitempty"` // non-empty for pattern migration
	Cursor             string                      `protobuf:"bytes,2,opt,name=cursor,proto3" json:"cursor,omitempty"`                                    // last processed address (lexicographic)
	MigratedAccounts   uint64                      `protobuf:"varint,3,opt,name=migrated_accounts,json=migratedAccounts,proto3" json:"migrated_accounts,omitempty"`
	TargetSegmentTypes map[string]SegmentValueType `protobuf:"bytes,4,rep,name=target_segment_types,json=targetSegmentTypes,proto3" json:"target_segment_types,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value,enum=common.SegmentValueType"` // non-empty for re-encoding migration
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *AccountTypeMigration) Reset() {
	*x = AccountTypeMigration{}
	mi := &file_common_proto_msgTypes[97]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AccountTypeMigration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AccountTypeMigration) ProtoMessage() {}

func (x *AccountTypeMigration) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[97]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AccountTypeMigration.ProtoReflect.Descriptor instead.
func (*AccountTypeMigration) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{97}
}

func (x *AccountTypeMigration) GetTargetPattern() string {
	if x != nil {
...
func (x *AccountTypeMigration) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
func (x *AccountTypeMigration) GetMigratedAccounts() uint64 {
	if x != nil {
...
func (x *AccountTypeMigration) GetTargetSegmentTypes() map[string]SegmentValueType {
	if x != nil {
		return x.TargetSegmentTypes
	}
	return nil
}

// StartedAccountMigrationLog records the start of a pattern migration.
type StartedAccountMigrationLog struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	...
	OldPattern      string                 `protobuf:"bytes,2,opt,name=old_pattern,json=oldPattern,proto3" json:"old_pattern,omitempty"`
	TargetPattern   string                 `protobuf:"bytes,3,opt,name=target_pattern,json=targetPattern,proto3" json:"target_pattern,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *StartedAccountMigrationLog) Reset() {
	*x = StartedAccountMigrationLog{}
	mi := &file_common_proto_msgTypes[98]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StartedAccountMigrationLog) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartedAccountMigrationLog) ProtoMessage() {}

func (x *StartedAccountMigrationLog) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[98]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartedAccountMigrationLog.ProtoReflect.Descriptor instead.
func (*StartedAccountMigrationLog) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{98}
}

func (x *StartedAccountMigrationLog) GetAccountTypeName() string {
	if x != nil {
...
func (x *StartedAccountMigrationLog) GetOldPattern() string {
	if x != nil {
		return x.OldPattern
	}
	return ""
...
func (x *StartedAccountMigrationLog) GetTargetPattern() string {
	if x != nil {
		return x.TargetPattern
	}
	return ""
...
type AccountMigrationBatchLog struct {
	state           protoimpl.MessageState      `protogen:"open.v1"`
	AccountTypeName string                      `protobuf:"bytes,1,opt,name=account_type_name,json=accountTypeName,proto3" json:"account_type_name,omitempty"`
	Count           uint32                      `protobuf:"varint,2,opt,name=count,proto3" json:"count,omitempty"`
	Entries         []*AccountMigrationEntryLog `protobuf:"bytes,3,rep,name=entries,proto3" json:"entries,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *AccountMigrationBatchLog) Reset() {
	*x = AccountMigrationBatchLog{}
	mi := &file_common_proto_msgTypes[99]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AccountMigrationBatchLog) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AccountMigrationBatchLog) ProtoMessage() {}

func (x *AccountMigrationBatchLog) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[99]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AccountMigrationBatchLog.ProtoReflect.Descriptor instead.
func (*AccountMigrationBatchLog) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{99}
}

func (x *AccountMigrationBatchLog) GetAccountTypeName() string {
	if x != nil {
		return x.AccountTypeName
	}
	return ""
...
func (x *AccountMigrationBatchLog) GetCount() uint32 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *AccountMigrationBatchLog) GetEntries() []*AccountMigrationEntryLog {
	if x != nil {
		return x.Entries
	}
	return nil
...
// checker can replay volume/metadata movements and re-encoding in the read store.
type AccountMigrationEntryLog struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	...
	OldEncodedAccount []byte                 `protobuf:"bytes,5,opt,name=old_encoded_account,json=oldEncodedAccount,proto3" json:"old_encoded_account,omitempty"` // old key encoding for read store cleanup
	NewEncodedAccount []byte                 `protobuf:"bytes,6,opt,name=new_encoded_account,json=newEncodedAccount,proto3" json:"new_encoded_account,omitempty"` // new key encoding for read store writes
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}

func (x *AccountMigrationEntryLog) Reset() {
	*x = AccountMigrationEntryLog{}
	mi := &file_common_proto_msgTypes[100]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AccountMigrationEntryLog) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AccountMigrationEntryLog) ProtoMessage() {}

func (x *AccountMigrationEntryLog) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[100]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AccountMigrationEntryLog.ProtoReflect.Descriptor instead.
func (*AccountMigrationEntryLog) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{100}
}

func (x *AccountMigrationEntryLog) GetOldAddress() string {
	if x != nil {
		return x.OldAddress
	}
	return ""
...
func (x *AccountMigrationEntryLog) GetNewAddress() string {
	if x != nil {
		return x.NewAddress
	}
	return ""
...
func (x *AccountMigrationEntryLog) GetAssets() []string {
	if x != nil {
		return x.Assets
	}
	return nil
...
func (x *AccountMigrationEntryLog) GetMetadataKeys() []string {
	if x != nil {
...
func (x *AccountMigrationEntryLog) GetOldEncodedAccount() []byte {
	if x != nil {
		return x.OldEncodedAccount
	}
	return nil
}

func (x *AccountMigrationEntryLog) GetNewEncodedAccount() []byte {
	if x != nil {
		return x.NewEncodedAccount
	}
	return nil
}

// CompletedAccountMigrationLog records the completion of a pattern migration.
type CompletedAccountMigrationLog struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	AccountTypeName string                 `protobuf:"bytes,1,opt,name=account_type_name,json=accountTypeName,proto3" json:"account_type_name,omitempty"`
	OldPattern      string                 `protobuf:"bytes,2,opt,name=old_pattern,json=oldPattern,proto3" json:"old_pattern,omitempty"`
	NewPattern      string                 `protobuf:"bytes,3,opt,name=new_pattern,json=newPattern,proto3" json:"new_pattern,omitempty"`
	TotalMigrated   uint64                 `protobuf:"varint,4,opt,name=total_migrated,json=totalMigrated,proto3" json:"total_migrated,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *CompletedAccountMigrationLog) Reset() {
	*x = CompletedAccountMigrationLog{}
	mi := &file_common_proto_msgTypes[101]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CompletedAccountMigrationLog) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompletedAccountMigrationLog) ProtoMessage() {}

func (x *CompletedAccountMigrationLog) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[101]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompletedAccountMigrationLog.ProtoReflect.Descriptor instead.
func (*CompletedAccountMigrationLog) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{101}
}

func (x *CompletedAccountMigrationLog) GetAccountTypeName() string {
	if x != nil {
		return x.AccountTypeName
	}
	return ""
...
func (x *CompletedAccountMigrationLog) GetOldPattern() string {
	if x != nil {
		return x.OldPattern
	}
	return ""
...
func (x *CompletedAccountMigrationLog) GetNewPattern() string {
	if x != nil {
		return x.NewPattern
	}
	return ""
...
func (x *CompletedAccountMigrationLog) GetTotalMigrated() uint64 {
	if x != nil {
...
const file_common_proto_rawDesc = "" +
	...
	"\fhash_version\x18\b \x01(\rR\vhashVersion\"\xd9\x0f\n" +
	"\n" +
	"LogPayload\x12>\n" +
	...
	" delete_query_checkpoint_schedule\x18\x1a \x01(\v2(.common.DeleteQueryCheckpointScheduleLogH\x00R\x1ddeleteQueryCheckpointScheduleB\x06\n" +
	"\x04type\"&\n" +
	...
	"\x02id\x18\x03 \x01(\x04R\x02id\"\xe2\v\n" +
	...
	"\aversion\x18\x01 \x01(\tR\aversion\"\x93\x03\n" +
	...
	"\vpersistence\x18\x04 \x01(\x0e2\x1e.common.AccountTypePersistenceR\vpersistence\x12:\n" +
	"\tmigration\x18\x05 \x01(\v2\x1c.common.AccountTypeMigrationR\tmigration\x12J\n" +
	"\rsegment_types\x18\x06 \x03(\v2%.common.AccountType.SegmentTypesEntryR\fsegmentTypes\x1aY\n" +
	"\x11SegmentTypesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12.\n" +
	"\x05value\x18\x02 \x01(\x0e2\x18.common.SegmentValueTypeR\x05value:\x028\x01\"M\n" +
	...
	"\x10enforcement_mode\x18\x01 \x01(\x0e2\x1c.common.ChartEnforcementModeR\x0fenforcementMode\"\xcb\x02\n" +
	"\x14AccountTypeMigration\x12%\n" +
	"\x0etarget_pattern\x18\x01 \x01(\tR\rtargetPattern\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\x12+\n" +
	"\x11migrated_accounts\x18\x03 \x01(\x04R\x10migratedAccounts\x12f\n" +
	"\x14target_segment_types\x18\x04 \x03(\v24.common.AccountTypeMigration.TargetSegmentTypesEntryR\x12targetSegmentTypes\x1a_\n" +
	"\x17TargetSegmentTypesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12.\n" +
	"\x05value\x18\x02 \x01(\x0e2\x18.common.SegmentValueTypeR\x05value:\x028\x01\"\x90\x01\n" +
	"\x1aStartedAccountMigrationLog\x12*\n" +
	"\x11account_type_name\x18\x01 \x01(\tR\x0faccountTypeName\x12\x1f\n" +
	"\vold_pattern\x18\x02 \x01(\tR\n" +
	"oldPattern\x12%\n" +
	"\x0etarget_pattern\x18\x03 \x01(\tR\rtargetPattern\"\x98\x01\n" +
	"\x18AccountMigrationBatchLog\x12*\n" +
	"\x11account_type_name\x18\x01 \x01(\tR\x0faccountTypeName\x12\x14\n" +
	"\x05count\x18\x02 \x01(\rR\x05count\x12:\n" +
	"\aentries\x18\x03 \x03(\v2 .common.AccountMigrationEntryLogR\aentries\"\xf9\x01\n" +
	"\x18AccountMigrationEntryLog\x12\x1f\n" +
	"\vold_address\x18\x01 \x01(\tR\n" +
	"oldAddress\x12\x1f\n" +
	"\vnew_address\x18\x02 \x01(\tR\n" +
	"newAddress\x12\x16\n" +
	"\x06assets\x18\x03 \x03(\tR\x06assets\x12#\n" +
	"\rmetadata_keys\x18\x04 \x03(\tR\fmetadataKeys\x12.\n" +
	"\x13old_encoded_account\x18\x05 \x01(\fR\x11oldEncodedAccount\x12.\n" +
	"\x13new_encoded_account\x18\x06 \x01(\fR\x11newEncodedAccount\"\xb3\x01\n" +
	"\x1cCompletedAccountMigrationLog\x12*\n" +
	"\x11account_type_name\x18\x01 \x01(\tR\x0faccountTypeName\x12\x1f\n" +
	"\vold_pattern\x18\x02 \x01(\tR\n" +
	"oldPattern\x12\x1f\n" +
	"\vnew_pattern\x18\x03 \x01(\tR\n" +
	"newPattern\x12%\n" +
	"\x0etotal_migrated\x18\x04 \x01(\x04R\rtotalMigrated\"\x9b\x04\n" +
	"\vQueryFilter\x12.\n" +
	...
	"\x16ACCOUNT_TYPE_TRANSIENT\x10\x02*w\n" +
	"\x10SegmentValueType\x12\x18\n" +
	"\x14SEGMENT_VALUE_STRING\x10\x00\x12\x16\n" +
	"\x12SEGMENT_VALUE_UUID\x10\x01\x12\x18\n" +
	"\x14SEGMENT_VALUE_UINT64\x10\x02\x12\x17\n" +
	"\x13SEGMENT_VALUE_BYTES\x10\x03*e\n" +
...
var file_common_proto_msgTypes = make([]protoimpl.MessageInfo, 138)
var file_common_proto_goTypes = []any{
	...
	(SegmentValueType)(0),                    // 13: common.SegmentValueType
	...
	(*TargetTransaction)(nil),                // 34: common.TargetTransaction
	...
	(*TransactionIndex)(nil),                 // 39: common.TransactionIndex
	(*AccountIndex)(nil),                     // 40: common.AccountIndex
	(*BuiltinIndexConfig)(nil),               // 41: common.BuiltinIndexConfig
	(*LogBuiltinIndexConfig)(nil),            // 42: common.LogBuiltinIndexConfig
	(*Idempotency)(nil),                      // 43: common.Idempotency
	(*IdempotencyEntry)(nil),                 // 44: common.IdempotencyEntry
	(*Log)(nil),                              // 45: common.Log
	(*LogPayload)(nil),                       // 46: common.LogPayload
	(*PromoteLedgerLog)(nil),                 // 47: common.PromoteLedgerLog
	(*RegisterSigningKeyLog)(nil),            // 48: common.RegisterSigningKeyLog
	(*RevokeSigningKeyLog)(nil),              // 49: common.RevokeSigningKeyLog
	(*SigningKey)(nil),                       // 50: common.SigningKey
	(*SetSigningConfigLog)(nil),              // 51: common.SetSigningConfigLog
	(*AddedEventsSinkLog)(nil),               // 52: common.AddedEventsSinkLog
	(*RemovedEventsSinkLog)(nil),             // 53: common.RemovedEventsSinkLog
	(*SetMaintenanceModeLog)(nil),            // 54: common.SetMaintenanceModeLog
	(*SetPeriodScheduleLog)(nil),             // 55: common.SetPeriodScheduleLog
	(*DeletePeriodScheduleLog)(nil),          // 56: common.DeletePeriodScheduleLog
	...
	(*DeleteQueryCheckpointScheduleLog)(nil), // 64: common.DeleteQueryCheckpointScheduleLog
	...
	(*CreateLedgerLog)(nil),                  // 75: common.CreateLedgerLog
	(*DeleteLedgerLog)(nil),                  // 76: common.DeleteLedgerLog
	(*ApplyLedgerLog)(nil),                   // 77: common.ApplyLedgerLog
	(*LedgerLog)(nil),                        // 78: common.LedgerLog
	(*LedgerLogPayload)(nil),                 // 79: common.LedgerLogPayload
	(*CreateIndexLog)(nil),                   // 80: common.CreateIndexLog
	(*DropIndexLog)(nil),                     // 81: common.DropIndexLog
	(*IndexReadyLog)(nil),                    // 82: common.IndexReadyLog
	(*FillGapLog)(nil),                       // 83: common.FillGapLog
	(*ConvertMetadataBatchLog)(nil),          // 84: common.ConvertMetadataBatchLog
	(*ConvertMetadataBatchLogEntry)(nil),     // 85: common.ConvertMetadataBatchLogEntry
	(*MetadataConversionCompleteLog)(nil),    // 86: common.MetadataConversionCompleteLog
	...
	(*Period)(nil),                           // 93: common.Period
	(*ClosePeriodLog)(nil),                   // 94: common.ClosePeriodLog
	(*SealPeriodLog)(nil),                    // 95: common.SealPeriodLog
	(*ArchivePeriodLog)(nil),                 // 96: common.ArchivePeriodLog
	(*ConfirmArchivePeriodLog)(nil),          // 97: common.ConfirmArchivePeriodLog
	...
	(*AccountType)(nil),                      // 111: common.AccountType
	(*AddedAccountTypeLog)(nil),              // 112: common.AddedAccountTypeLog
	(*RemovedAccountTypeLog)(nil),            // 113: common.RemovedAccountTypeLog
	(*UpdatedDefaultEnforcementModeLog)(nil), // 114: common.UpdatedDefaultEnforcementModeLog
	(*AccountTypeMigration)(nil),             // 115: common.AccountTypeMigration
	(*StartedAccountMigrationLog)(nil),       // 116: common.StartedAccountMigrationLog
	(*AccountMigrationBatchLog)(nil),         // 117: common.AccountMigrationBatchLog
	(*AccountMigrationEntryLog)(nil),         // 118: common.AccountMigrationEntryLog
	(*CompletedAccountMigrationLog)(nil),     // 119: common.CompletedAccountMigrationLog
	...
	nil,                                      // 143: common.Script.VarsEntry
	nil,                                      // 144: common.VolumesByAssets.VolumesEntry
	nil,                                      // 145: common.PostCommitVolumes.VolumesByAccountEntry
	nil,                                      // 146: common.Account.VolumesEntry
	nil,                                      // 147: common.MetadataSchema.AccountFieldsEntry
	nil,                                      // 148: common.MetadataSchema.TransactionFieldsEntry
	nil,                                      // 149: common.CreateLedgerLog.AccountTypesEntry
	nil,                                      // 150: common.CreatedTransaction.AccountMetadataEntry
	nil,                                      // 151: common.CreatedTransaction.PreviousAccountMetadataEntry
	nil,                                      // 152: common.SavedMetadata.PreviousValuesEntry
	nil,                                      // 153: common.LedgerInfo.AccountTypesEntry
	nil,                                      // 154: common.AccountType.SegmentTypesEntry
	nil,                                      // 155: common.AccountTypeMigration.TargetSegmentTypesEntry
...
var file_common_proto_depIdxs = []int32{
	21,  // 0: common.Metadata.value:type_name -> common.MetadataValue
	20,  // 1: common.MetadataValue.null_value:type_name -> common.NullValue
	19,  // 2: common.MetadataSet.metadata:type_name -> common.Metadata
	24,  // 3: common.Posting.amount:type_name -> common.Uint256
	25,  // 4: common.Transaction.postings:type_name -> common.Posting
	22,  // 5: common.Transaction.metadata:type_name -> common.MetadataSet
	18,  // 6: common.Transaction.timestamp:type_name -> common.Timestamp
	18,  // 7: common.Transaction.inserted_at:type_name -> common.Timestamp
	18,  // 8: common.Transaction.updated_at:type_name -> common.Timestamp
	18,  // 9: common.Transaction.reverted_at:type_name -> common.Timestamp
	143, // 10: common.Script.vars:type_name -> common.Script.VarsEntry
	144, // 11: common.VolumesByAssets.volumes:type_name -> common.VolumesByAssets.VolumesEntry
	145, // 12: common.PostCommitVolumes.volumes_by_account:type_name -> common.PostCommitVolumes.VolumesByAccountEntry
	22,  // 13: common.Account.metadata:type_name -> common.MetadataSet
	18,  // 14: common.Account.first_usage:type_name -> common.Timestamp
	18,  // 15: common.Account.insertion_date:type_name -> common.Timestamp
	18,  // 16: common.Account.updated_at:type_name -> common.Timestamp
	146, // 17: common.Account.volumes:type_name -> common.Account.VolumesEntry
	33,  // 18: common.Target.account:type_name -> common.TargetAccount
	34,  // 19: common.Target.transaction:type_name -> common.TargetTransaction
	...
	147, // 23: common.MetadataSchema.account_fields:type_name -> common.MetadataSchema.AccountFieldsEntry
	148, // 24: common.MetadataSchema.transaction_fields:type_name -> common.MetadataSchema.TransactionFieldsEntry
	...
	46,  // 37: common.Log.payload:type_name -> common.LogPayload
	43,  // 38: common.Log.idempotency:type_name -> common.Idempotency
	156, // 39: common.Log.signature:type_name -> signature.RequestSignature
	157, // 40: common.Log.response_signature:type_name -> signature.ResponseSignature
	75,  // 41: common.LogPayload.create_ledger:type_name -> common.CreateLedgerLog
	76,  // 42: common.LogPayload.delete_ledger:type_name -> common.DeleteLedgerLog
	77,  // 43: common.LogPayload.apply:type_name -> common.ApplyLedgerLog
	48,  // 44: common.LogPayload.register_signing_key:type_name -> common.RegisterSigningKeyLog
	49,  // 45: common.LogPayload.revoke_signing_key:type_name -> common.RevokeSigningKeyLog
	51,  // 46: common.LogPayload.set_signing_config:type_name -> common.SetSigningConfigLog
	52,  // 47: common.LogPayload.added_events_sink:type_name -> common.AddedEventsSinkLog
	53,  // 48: common.LogPayload.removed_events_sink:type_name -> common.RemovedEventsSinkLog
	94,  // 49: common.LogPayload.close_period:type_name -> common.ClosePeriodLog
	95,  // 50: common.LogPayload.seal_period:type_name -> common.SealPeriodLog
	96,  // 51: common.LogPayload.archive_period:type_name -> common.ArchivePeriodLog
	97,  // 52: common.LogPayload.confirm_archive_period:type_name -> common.ConfirmArchivePeriodLog
	54,  // 53: common.LogPayload.set_maintenance_mode:type_name -> common.SetMaintenanceModeLog
	55,  // 54: common.LogPayload.set_period_schedule:type_name -> common.SetPeriodScheduleLog
	56,  // 55: common.LogPayload.delete_period_schedule:type_name -> common.DeletePeriodScheduleLog
	47,  // 56: common.LogPayload.promote_ledger:type_name -> common.PromoteLedgerLog
	57,  // 57: common.LogPayload.created_prepared_query:type_name -> common.CreatedPreparedQueryLog
	58,  // 58: common.LogPayload.updated_prepared_query:type_name -> common.UpdatedPreparedQueryLog
	59,  // 59: common.LogPayload.deleted_prepared_query:type_name -> common.DeletedPreparedQueryLog
	61,  // 60: common.LogPayload.saved_numscript:type_name -> common.SavedNumscriptLog
	62,  // 61: common.LogPayload.deleted_numscript:type_name -> common.DeletedNumscriptLog
	65,  // 62: common.LogPayload.created_query_checkpoint:type_name -> common.CreatedQueryCheckpointLog
	66,  // 63: common.LogPayload.deleted_query_checkpoint:type_name -> common.DeletedQueryCheckpointLog
	63,  // 64: common.LogPayload.set_query_checkpoint_schedule:type_name -> common.SetQueryCheckpointScheduleLog
	64,  // 65: common.LogPayload.delete_query_checkpoint_schedule:type_name -> common.DeleteQueryCheckpointScheduleLog
	67,  // 66: common.AddedEventsSinkLog.config:type_name -> common.SinkConfig
	137, // 67: common.CreatedPreparedQueryLog.query:type_name -> common.PreparedQuery
	120, // 68: common.UpdatedPreparedQueryLog.previous_filter:type_name -> common.QueryFilter
	120, // 69: common.UpdatedPreparedQueryLog.new_filter:type_name -> common.QueryFilter
	18,  // 70: common.NumscriptInfo.created_at:type_name -> common.Timestamp
	60,  // 71: common.SavedNumscriptLog.info:type_name -> common.NumscriptInfo
	70,  // 72: common.SinkConfig.nats:type_name -> common.NatsSinkConfig
	71,  // 73: common.SinkConfig.clickhouse:type_name -> common.ClickHouseSinkConfig
	72,  // 74: common.SinkConfig.kafka:type_name -> common.KafkaSinkConfig
	73,  // 75: common.SinkConfig.http:type_name -> common.HttpSinkConfig
	74,  // 76: common.SinkConfig.databricks:type_name -> common.DatabricksSinkConfig
	7,   // 77: common.SinkConfig.event_types:type_name -> common.EventType
	69,  // 78: common.SinkStatus.error:type_name -> common.SinkError
	18,  // 79: common.SinkError.occurred_at:type_name -> common.Timestamp
	18,  // 80: common.CreateLedgerLog.created_at:type_name -> common.Timestamp
	37,  // 81: common.CreateLedgerLog.metadata_schema:type_name -> common.MetadataSchema
	9,   // 82: common.CreateLedgerLog.mode:type_name -> common.LedgerMode
	98,  // 83: common.CreateLedgerLog.mirror_source:type_name -> common.MirrorSourceConfig
	149, // 84: common.CreateLedgerLog.account_types:type_name -> common.CreateLedgerLog.AccountTypesEntry
	11,  // 85: common.CreateLedgerLog.default_enforcement_mode:type_name -> common.ChartEnforcementMode
	18,  // 86: common.DeleteLedgerLog.deleted_at:type_name -> common.Timestamp
	78,  // 87: common.ApplyLedgerLog.log:type_name -> common.LedgerLog
	79,  // 88: common.LedgerLog.data:type_name -> common.LedgerLogPayload
	18,  // 89: common.LedgerLog.date:type_name -> common.Timestamp
	87,  // 90: common.LedgerLogPayload.created_transaction:type_name -> common.CreatedTransaction
	88,  // 91: common.LedgerLogPayload.reverted_transaction:type_name -> common.RevertedTransaction
	89,  // 92: common.LedgerLogPayload.saved_metadata:type_name -> common.SavedMetadata
	90,  // 93: common.LedgerLogPayload.deleted_metadata:type_name -> common.DeletedMetadata
	91,  // 94: common.LedgerLogPayload.set_metadata_field_type:type_name -> common.SetMetadataFieldTypeLog
	92,  // 95: common.LedgerLogPayload.removed_metadata_field_type:type_name -> common.RemovedMetadataFieldTypeLog
	84,  // 96: common.LedgerLogPayload.convert_metadata_batch:type_name -> common.ConvertMetadataBatchLog
	86,  // 97: common.LedgerLogPayload.metadata_conversion_complete:type_name -> common.MetadataConversionCompleteLog
	83,  // 98: common.LedgerLogPayload.fill_gap:type_name -> common.FillGapLog
	80,  // 99: common.LedgerLogPayload.create_index:type_name -> common.CreateIndexLog
	81,  // 100: common.LedgerLogPayload.drop_index:type_name -> common.DropIndexLog
	82,  // 101: common.LedgerLogPayload.index_ready:type_name -> common.IndexReadyLog
	112, // 102: common.LedgerLogPayload.added_account_type:type_name -> common.AddedAccountTypeLog
	113, // 103: common.LedgerLogPayload.removed_account_type:type_name -> common.RemovedAccountTypeLog
	114, // 104: common.LedgerLogPayload.updated_default_enforcement_mode:type_name -> common.UpdatedDefaultEnforcementModeLog
	116, // 105: common.LedgerLogPayload.started_account_migration:type_name -> common.StartedAccountMigrationLog
	117, // 106: common.LedgerLogPayload.account_migration_batch:type_name -> common.AccountMigrationBatchLog
	119, // 107: common.LedgerLogPayload.completed_account_migration:type_name -> common.CompletedAccountMigrationLog
	6,   // 108: common.CreateIndexLog.log_builtin:type_name -> common.LogBuiltinIndex
	39,  // 109: common.CreateIndexLog.transaction:type_name -> common.TransactionIndex
	40,  // 110: common.CreateIndexLog.account:type_name -> common.AccountIndex
	6,   // 111: common.DropIndexLog.log_builtin:type_name -> common.LogBuiltinIndex
	39,  // 112: common.DropIndexLog.transaction:type_name -> common.TransactionIndex
	40,  // 113: common.DropIndexLog.account:type_name -> common.AccountIndex
	6,   // 114: common.IndexReadyLog.log_builtin:type_name -> common.LogBuiltinIndex
	39,  // 115: common.IndexReadyLog.transaction:type_name -> common.TransactionIndex
	40,  // 116: common.IndexReadyLog.account:type_name -> common.AccountIndex
	0,   // 117: common.ConvertMetadataBatchLog.target_type:type_name -> common.TargetType
	85,  // 118: common.ConvertMetadataBatchLog.entries:type_name -> common.ConvertMetadataBatchLogEntry
	21,  // 119: common.ConvertMetadataBatchLogEntry.new_value:type_name -> common.MetadataValue
	0,   // 120: common.MetadataConversionCompleteLog.target_type:type_name -> common.TargetType
	26,  // 121: common.CreatedTransaction.transaction:type_name -> common.Transaction
	150, // 122: common.CreatedTransaction.account_metadata:type_name -> common.CreatedTransaction.AccountMetadataEntry
	31,  // 123: common.CreatedTransaction.post_commit_volumes:type_name -> common.PostCommitVolumes
	151, // 124: common.CreatedTransaction.previous_account_metadata:type_name -> common.CreatedTransaction.PreviousAccountMetadataEntry
	26,  // 125: common.RevertedTransaction.revert_transaction:type_name -> common.Transaction
	...
	22,  // 128: common.SavedMetadata.metadata:type_name -> common.MetadataSet
	152, // 129: common.SavedMetadata.previous_values:type_name -> common.SavedMetadata.PreviousValuesEntry
	35,  // 130: common.DeletedMetadata.target:type_name -> common.Target
	21,  // 131: common.DeletedMetadata.previous_value:type_name -> common.MetadataValue
	...
	18,  // 135: common.Period.start:type_name -> common.Timestamp
	18,  // 136: common.Period.end:type_name -> common.Timestamp
	8,   // 137: common.Period.status:type_name -> common.PeriodStatus
	93,  // 138: common.ClosePeriodLog.closed_period:type_name -> common.Period
	93,  // 139: common.ClosePeriodLog.new_period:type_name -> common.Period
	93,  // 140: common.SealPeriodLog.period:type_name -> common.Period
	93,  // 141: common.ArchivePeriodLog.period:type_name -> common.Period
	93,  // 142: common.ConfirmArchivePeriodLog.period:type_name -> common.Period
	99,  // 143: common.MirrorSourceConfig.http:type_name -> common.HttpMirrorSourceConfig
	101, // 144: common.MirrorSourceConfig.postgres:type_name -> common.PostgresMirrorSourceConfig
	100, // 145: common.HttpMirrorSourceConfig.oauth2_client_credentials:type_name -> common.OAuth2ClientCredentials
	18,  // 146: common.MirrorSyncError.occurred_at:type_name -> common.Timestamp
	10,  // 147: common.MirrorSyncProgress.state:type_name -> common.MirrorSyncState
	102, // 148: common.MirrorSyncProgress.error:type_name -> common.MirrorSyncError
	18,  // 149: common.LedgerInfo.created_at:type_name -> common.Timestamp
	18,  // 150: common.LedgerInfo.deleted_at:type_name -> common.Timestamp
	37,  // 151: common.LedgerInfo.metadata_schema:type_name -> common.MetadataSchema
	9,   // 152: common.LedgerInfo.mode:type_name -> common.LedgerMode
	98,  // 153: common.LedgerInfo.mirror_source:type_name -> common.MirrorSourceConfig
	103, // 154: common.LedgerInfo.mirror_sync_progress:type_name -> common.MirrorSyncProgress
	41,  // 155: common.LedgerInfo.builtin_indexes:type_name -> common.BuiltinIndexConfig
	42,  // 156: common.LedgerInfo.log_builtin_indexes:type_name -> common.LogBuiltinIndexConfig
	153, // 157: common.LedgerInfo.account_types:type_name -> common.LedgerInfo.AccountTypesEntry
	11,  // 158: common.LedgerInfo.default_enforcement_mode:type_name -> common.ChartEnforcementMode
	35,  // 159: common.SaveMetadataCommand.target:type_name -> common.Target
	22,  // 160: common.SaveMetadataCommand.metadata:type_name -> common.MetadataSet
	35,  // 161: common.DeleteMetadataCommand.target:type_name -> common.Target
	22,  // 162: common.TransactionState.metadata:type_name -> common.MetadataSet
	14,  // 163: common.AccountType.status:type_name -> common.AccountTypeStatus
	12,  // 164: common.AccountType.persistence:type_name -> common.AccountTypePersistence
	115, // 165: common.AccountType.migration:type_name -> common.AccountTypeMigration
	154, // 166: common.AccountType.segment_types:type_name -> common.AccountType.SegmentTypesEntry
	111, // 167: common.AddedAccountTypeLog.account_type:type_name -> common.AccountType
	11,  // 168: common.UpdatedDefaultEnforcementModeLog.enforcement_mode:type_name -> common.ChartEnforcementMode
	155, // 169: common.AccountTypeMigration.target_segment_types:type_name -> common.AccountTypeMigration.TargetSegmentTypesEntry
	118, // 170: common.AccountMigrationBatchLog.entries:type_name -> common.AccountMigrationEntryLog
	130, // 171: common.QueryFilter.field:type_name -> common.FieldCondition
	136, // 172: common.QueryFilter.address:type_name -> common.AddressMatch
	126, // 173: common.QueryFilter.and:type_name -> common.AndFilter
	127, // 174: common.QueryFilter.or:type_name -> common.OrFilter
	128, // 175: common.QueryFilter.not:type_name -> common.NotFilter
	121, // 176: common.QueryFilter.reference:type_name -> common.ReferenceCondition
	124, // 177: common.QueryFilter.builtin_uint:type_name -> common.BuiltinUintCondition
	122, // 178: common.QueryFilter.ledger:type_name -> common.LedgerCondition
	123, // 179: common.QueryFilter.log_id:type_name -> common.LogIdCondition
	125, // 180: common.QueryFilter.log_builtin_uint:type_name -> common.LogBuiltinUintCondition
	131, // 181: common.ReferenceCondition.cond:type_name -> common.StringCondition
	131, // 182: common.LedgerCondition.cond:type_name -> common.StringCondition
	133, // 183: common.LogIdCondition.cond:type_name -> common.UintCondition
	4,   // 184: common.BuiltinUintCondition.field:type_name -> common.TransactionBuiltinIndex
	133, // 185: common.BuiltinUintCondition.cond:type_name -> common.UintCondition
	6,   // 186: common.LogBuiltinUintCondition.field:type_name -> common.LogBuiltinIndex
	133, // 187: common.LogBuiltinUintCondition.cond:type_name -> common.UintCondition
	120, // 188: common.AndFilter.filters:type_name -> common.QueryFilter
	120, // 189: common.OrFilter.filters:type_name -> common.QueryFilter
	120, // 190: common.NotFilter.filter:type_name -> common.QueryFilter
	129, // 191: common.FieldCondition.field:type_name -> common.FieldRef
	131, // 192: common.FieldCondition.string_cond:type_name -> common.StringCondition
	132, // 193: common.FieldCondition.int_cond:type_name -> common.IntCondition
	133, // 194: common.FieldCondition.uint_cond:type_name -> common.UintCondition
	134, // 195: common.FieldCondition.bool_cond:type_name -> common.BoolCondition
	135, // 196: common.FieldCondition.exists_cond:type_name -> common.ExistsCondition
	15,  // 197: common.AddressMatch.role:type_name -> common.AddressRole
	120, // 198: common.PreparedQuery.filter:type_name -> common.QueryFilter
	16,  // 199: common.PreparedQuery.target:type_name -> common.QueryTarget
	24,  // 200: common.AggregatedVolume.input:type_name -> common.Uint256
	24,  // 201: common.AggregatedVolume.output:type_name -> common.Uint256
	138, // 202: common.AggregateResult.volumes:type_name -> common.AggregatedVolume
	140, // 203: common.AggregateResult.groups:type_name -> common.GroupedAggregateResult
	138, // 204: common.GroupedAggregateResult.volumes:type_name -> common.AggregatedVolume
	32,  // 205: common.PreparedQueryCursor.account_data:type_name -> common.Account
	26,  // 206: common.PreparedQueryCursor.transaction_data:type_name -> common.Transaction
	28,  // 207: common.VolumesByAssets.VolumesEntry.value:type_name -> common.Volumes
	30,  // 208: common.PostCommitVolumes.VolumesByAccountEntry.value:type_name -> common.VolumesByAssets
	29,  // 209: common.Account.VolumesEntry.value:type_name -> common.VolumesWithBalance
	36,  // 210: common.MetadataSchema.AccountFieldsEntry.value:type_name -> common.MetadataFieldSchema
	36,  // 211: common.MetadataSchema.TransactionFieldsEntry.value:type_name -> common.MetadataFieldSchema
	111, // 212: common.CreateLedgerLog.AccountTypesEntry.value:type_name -> common.AccountType
	22,  // 213: common.CreatedTransaction.AccountMetadataEntry.value:type_name -> common.MetadataSet
	22,  // 214: common.CreatedTransaction.PreviousAccountMetadataEntry.value:type_name -> common.MetadataSet
	21,  // 215: common.SavedMetadata.PreviousValuesEntry.value:type_name -> common.MetadataValue
	111, // 216: common.LedgerInfo.AccountTypesEntry.value:type_name -> common.AccountType
	13,  // 217: common.AccountType.SegmentTypesEntry.value:type_name -> common.SegmentValueType
	13,  // 218: common.AccountTypeMigration.TargetSegmentTypesEntry.value:type_name -> common.SegmentValueType
...
func file_common_proto_init() {
	...
	file_common_proto_msgTypes[49].OneofWrappers = []any{
		(*SinkConfig_Nats)(nil),
	...
	file_common_proto_msgTypes[61].OneofWrappers = []any{
		...
		(*LedgerLogPayload_StartedAccountMigration)(nil),
		(*LedgerLogPayload_AccountMigrationBatch)(nil),
		(*LedgerLogPayload_CompletedAccountMigration)(nil),
	}
