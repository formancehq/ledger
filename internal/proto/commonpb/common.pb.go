...
// proposal applied normally. The `reason` is hash-chain-bound via the
// AuditItem.serialized_order + LedgerLog projection; the checker re-derives
// the projection at the applied index and confirms the matching error would
// have been produced (defense against forged skip entries).
