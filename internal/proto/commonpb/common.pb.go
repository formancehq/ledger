...
const file_common_proto_rawDesc = "" +
	...
	"\afp_rate\x18\x02 \x01(\x01R\x06fpRate\"\xf5\x05\n" +
	"\rClusterConfig\x12-\n" +
	...
	"\x0ehash_algorithm\x18\v \x01(\x0e2\x15.common.HashAlgorithmR\rhashAlgorithm\"g\n" +
...
var file_common_proto_goTypes = []any{
	...
	(*DeleteQueryCheckpointScheduleLog)(nil), // 66: common.DeleteQueryCheckpointScheduleLog
	...
	(*CreateLedgerLog)(nil),                  // 77: common.CreateLedgerLog
	(*DeleteLedgerLog)(nil),                  // 78: common.DeleteLedgerLog
	...
	(*CreateIndexLog)(nil),                   // 82: common.CreateIndexLog
	(*DropIndexLog)(nil),                     // 83: common.DropIndexLog
	(*IndexReadyLog)(nil),                    // 84: common.IndexReadyLog
	(*FillGapLog)(nil),                       // 85: common.FillGapLog
	(*ConvertMetadataBatchLog)(nil),          // 86: common.ConvertMetadataBatchLog
	(*ConvertMetadataBatchLogEntry)(nil),     // 87: common.ConvertMetadataBatchLogEntry
	(*MetadataConversionCompleteLog)(nil),    // 88: common.MetadataConversionCompleteLog
	...
	(*Period)(nil),                           // 95: common.Period
	(*ClosePeriodLog)(nil),                   // 96: common.ClosePeriodLog
	(*SealPeriodLog)(nil),                    // 97: common.SealPeriodLog
	(*ArchivePeriodLog)(nil),                 // 98: common.ArchivePeriodLog
	(*ConfirmArchivePeriodLog)(nil),          // 99: common.ConfirmArchivePeriodLog
	(*MirrorSourceConfig)(nil),               // 100: common.MirrorSourceConfig
	(*HttpMirrorSourceConfig)(nil),           // 101: common.HttpMirrorSourceConfig
	(*OAuth2ClientCredentials)(nil),          // 102: common.OAuth2ClientCredentials
	(*PostgresMirrorSourceConfig)(nil),       // 103: common.PostgresMirrorSourceConfig
	...
	nil,                                      // 140: common.MetadataMap.ValuesEntry
	nil,                                      // 141: common.Transaction.MetadataEntry
	...
	nil,                                      // 145: common.Account.MetadataEntry
	...
	nil,                                      // 152: common.SavedMetadata.MetadataEntry
	nil,                                      // 153: common.SavedMetadata.PreviousValuesEntry
	nil,                                      // 154: common.LedgerInfo.AccountTypesEntry
	nil,                                      // 155: common.SaveMetadataCommand.MetadataEntry
	nil,                                      // 156: common.TransactionState.MetadataEntry
	(*signaturepb.RequestSignature)(nil),     // 157: signature.RequestSignature
	(*signaturepb.ResponseSignature)(nil),    // 158: signature.ResponseSignature
}
var file_common_proto_depIdxs = []int32{
	19,  // 0: common.MetadataValue.null_value:type_name -> common.NullValue
	140, // 1: common.MetadataMap.values:type_name -> common.MetadataMap.ValuesEntry
	23,  // 2: common.Posting.amount:type_name -> common.Uint256
	24,  // 3: common.Transaction.postings:type_name -> common.Posting
	141, // 4: common.Transaction.metadata:type_name -> common.Transaction.MetadataEntry
	...
	142, // 9: common.Script.vars:type_name -> common.Script.VarsEntry
	143, // 10: common.VolumesByAssets.volumes:type_name -> common.VolumesByAssets.VolumesEntry
	144, // 11: common.PostCommitVolumes.volumes_by_account:type_name -> common.PostCommitVolumes.VolumesByAccountEntry
	145, // 12: common.Account.metadata:type_name -> common.Account.MetadataEntry
	...
	146, // 16: common.Account.volumes:type_name -> common.Account.VolumesEntry
	...
	147, // 22: common.MetadataSchema.account_fields:type_name -> common.MetadataSchema.AccountFieldsEntry
	148, // 23: common.MetadataSchema.transaction_fields:type_name -> common.MetadataSchema.TransactionFieldsEntry
	...
	157, // 38: common.Log.signature:type_name -> signature.RequestSignature
	158, // 39: common.Log.response_signature:type_name -> signature.ResponseSignature
	77,  // 40: common.LogPayload.create_ledger:type_name -> common.CreateLedgerLog
	78,  // 41: common.LogPayload.delete_ledger:type_name -> common.DeleteLedgerLog
	79,  // 42: common.LogPayload.apply:type_name -> common.ApplyLedgerLog
	...
	96,  // 48: common.LogPayload.close_period:type_name -> common.ClosePeriodLog
	97,  // 49: common.LogPayload.seal_period:type_name -> common.SealPeriodLog
	98,  // 50: common.LogPayload.archive_period:type_name -> common.ArchivePeriodLog
	99,  // 51: common.LogPayload.confirm_archive_period:type_name -> common.ConfirmArchivePeriodLog
	...
	63,  // 59: common.LogPayload.saved_numscript:type_name -> common.SavedNumscriptLog
	64,  // 60: common.LogPayload.deleted_numscript:type_name -> common.DeletedNumscriptLog
	67,  // 61: common.LogPayload.created_query_checkpoint:type_name -> common.CreatedQueryCheckpointLog
	68,  // 62: common.LogPayload.deleted_query_checkpoint:type_name -> common.DeletedQueryCheckpointLog
	65,  // 63: common.LogPayload.set_query_checkpoint_schedule:type_name -> common.SetQueryCheckpointScheduleLog
	66,  // 64: common.LogPayload.delete_query_checkpoint_schedule:type_name -> common.DeleteQueryCheckpointScheduleLog
	69,  // 65: common.AddedEventsSinkLog.config:type_name -> common.SinkConfig
	...
	55,  // 76: common.PersistedClusterState.config:type_name -> common.ClusterConfig
	...
	18,  // 80: common.NumscriptInfo.created_at:type_name -> common.Timestamp
	62,  // 81: common.SavedNumscriptLog.info:type_name -> common.NumscriptInfo
	...
	8,   // 87: common.SinkConfig.event_types:type_name -> common.EventType
	71,  // 88: common.SinkStatus.error:type_name -> common.SinkError
	18,  // 89: common.SinkError.occurred_at:type_name -> common.Timestamp
	18,  // 90: common.CreateLedgerLog.created_at:type_name -> common.Timestamp
	36,  // 91: common.CreateLedgerLog.metadata_schema:type_name -> common.MetadataSchema
	10,  // 92: common.CreateLedgerLog.mode:type_name -> common.LedgerMode
	100, // 93: common.CreateLedgerLog.mirror_source:type_name -> common.MirrorSourceConfig
	149, // 94: common.CreateLedgerLog.account_types:type_name -> common.CreateLedgerLog.AccountTypesEntry
	12,  // 95: common.CreateLedgerLog.default_enforcement_mode:type_name -> common.ChartEnforcementMode
	18,  // 96: common.DeleteLedgerLog.deleted_at:type_name -> common.Timestamp
	80,  // 97: common.ApplyLedgerLog.log:type_name -> common.LedgerLog
	81,  // 98: common.LedgerLog.data:type_name -> common.LedgerLogPayload
	18,  // 99: common.LedgerLog.date:type_name -> common.Timestamp
	89,  // 100: common.LedgerLogPayload.created_transaction:type_name -> common.CreatedTransaction
	90,  // 101: common.LedgerLogPayload.reverted_transaction:type_name -> common.RevertedTransaction
	91,  // 102: common.LedgerLogPayload.saved_metadata:type_name -> common.SavedMetadata
	92,  // 103: common.LedgerLogPayload.deleted_metadata:type_name -> common.DeletedMetadata
	93,  // 104: common.LedgerLogPayload.set_metadata_field_type:type_name -> common.SetMetadataFieldTypeLog
	94,  // 105: common.LedgerLogPayload.removed_metadata_field_type:type_name -> common.RemovedMetadataFieldTypeLog
	86,  // 106: common.LedgerLogPayload.convert_metadata_batch:type_name -> common.ConvertMetadataBatchLog
	88,  // 107: common.LedgerLogPayload.metadata_conversion_complete:type_name -> common.MetadataConversionCompleteLog
	85,  // 108: common.LedgerLogPayload.fill_gap:type_name -> common.FillGapLog
	82,  // 109: common.LedgerLogPayload.create_index:type_name -> common.CreateIndexLog
	83,  // 110: common.LedgerLogPayload.drop_index:type_name -> common.DropIndexLog
	84,  // 111: common.LedgerLogPayload.index_ready:type_name -> common.IndexReadyLog
	...
	6,   // 115: common.CreateIndexLog.log_builtin:type_name -> common.LogBuiltinIndex
	38,  // 116: common.CreateIndexLog.transaction:type_name -> common.TransactionIndex
	39,  // 117: common.CreateIndexLog.account:type_name -> common.AccountIndex
	6,   // 118: common.DropIndexLog.log_builtin:type_name -> common.LogBuiltinIndex
	38,  // 119: common.DropIndexLog.transaction:type_name -> common.TransactionIndex
	39,  // 120: common.DropIndexLog.account:type_name -> common.AccountIndex
	6,   // 121: common.IndexReadyLog.log_builtin:type_name -> common.LogBuiltinIndex
	38,  // 122: common.IndexReadyLog.transaction:type_name -> common.TransactionIndex
	39,  // 123: common.IndexReadyLog.account:type_name -> common.AccountIndex
	0,   // 124: common.ConvertMetadataBatchLog.target_type:type_name -> common.TargetType
	87,  // 125: common.ConvertMetadataBatchLog.entries:type_name -> common.ConvertMetadataBatchLogEntry
	20,  // 126: common.ConvertMetadataBatchLogEntry.new_value:type_name -> common.MetadataValue
	0,   // 127: common.MetadataConversionCompleteLog.target_type:type_name -> common.TargetType
	25,  // 128: common.CreatedTransaction.transaction:type_name -> common.Transaction
	150, // 129: common.CreatedTransaction.account_metadata:type_name -> common.CreatedTransaction.AccountMetadataEntry
	30,  // 130: common.CreatedTransaction.post_commit_volumes:type_name -> common.PostCommitVolumes
	151, // 131: common.CreatedTransaction.previous_account_metadata:type_name -> common.CreatedTransaction.PreviousAccountMetadataEntry
	25,  // 132: common.RevertedTransaction.revert_transaction:type_name -> common.Transaction
	30,  // 133: common.RevertedTransaction.post_commit_volumes:type_name -> common.PostCommitVolumes
	34,  // 134: common.SavedMetadata.target:type_name -> common.Target
	152, // 135: common.SavedMetadata.metadata:type_name -> common.SavedMetadata.MetadataEntry
	153, // 136: common.SavedMetadata.previous_values:type_name -> common.SavedMetadata.PreviousValuesEntry
	34,  // 137: common.DeletedMetadata.target:type_name -> common.Target
	20,  // 138: common.DeletedMetadata.previous_value:type_name -> common.MetadataValue
	0,   // 139: common.SetMetadataFieldTypeLog.target_type:type_name -> common.TargetType
	1,   // 140: common.SetMetadataFieldTypeLog.type:type_name -> common.MetadataType
	0,   // 141: common.RemovedMetadataFieldTypeLog.target_type:type_name -> common.TargetType
	18,  // 142: common.Period.start:type_name -> common.Timestamp
	18,  // 143: common.Period.end:type_name -> common.Timestamp
	9,   // 144: common.Period.status:type_name -> common.PeriodStatus
	95,  // 145: common.ClosePeriodLog.closed_period:type_name -> common.Period
	95,  // 146: common.ClosePeriodLog.new_period:type_name -> common.Period
	95,  // 147: common.SealPeriodLog.period:type_name -> common.Period
	95,  // 148: common.ArchivePeriodLog.period:type_name -> common.Period
	95,  // 149: common.ConfirmArchivePeriodLog.period:type_name -> common.Period
	101, // 150: common.MirrorSourceConfig.http:type_name -> common.HttpMirrorSourceConfig
	103, // 151: common.MirrorSourceConfig.postgres:type_name -> common.PostgresMirrorSourceConfig
	102, // 152: common.HttpMirrorSourceConfig.oauth2_client_credentials:type_name -> common.OAuth2ClientCredentials
	18,  // 153: common.MirrorSyncError.occurred_at:type_name -> common.Timestamp
	11,  // 154: common.MirrorSyncProgress.state:type_name -> common.MirrorSyncState
	104, // 155: common.MirrorSyncProgress.error:type_name -> common.MirrorSyncError
	18,  // 156: common.LedgerInfo.created_at:type_name -> common.Timestamp
	18,  // 157: common.LedgerInfo.deleted_at:type_name -> common.Timestamp
	36,  // 158: common.LedgerInfo.metadata_schema:type_name -> common.MetadataSchema
	10,  // 159: common.LedgerInfo.mode:type_name -> common.LedgerMode
	100, // 160: common.LedgerInfo.mirror_source:type_name -> common.MirrorSourceConfig
	105, // 161: common.LedgerInfo.mirror_sync_progress:type_name -> common.MirrorSyncProgress
	40,  // 162: common.LedgerInfo.builtin_indexes:type_name -> common.BuiltinIndexConfig
	41,  // 163: common.LedgerInfo.log_builtin_indexes:type_name -> common.LogBuiltinIndexConfig
	154, // 164: common.LedgerInfo.account_types:type_name -> common.LedgerInfo.AccountTypesEntry
	12,  // 165: common.LedgerInfo.default_enforcement_mode:type_name -> common.ChartEnforcementMode
	34,  // 166: common.SaveMetadataCommand.target:type_name -> common.Target
	155, // 167: common.SaveMetadataCommand.metadata:type_name -> common.SaveMetadataCommand.MetadataEntry
	34,  // 168: common.DeleteMetadataCommand.target:type_name -> common.Target
	156, // 169: common.TransactionState.metadata:type_name -> common.TransactionState.MetadataEntry
	14,  // 170: common.AccountType.status:type_name -> common.AccountTypeStatus
	13,  // 171: common.AccountType.persistence:type_name -> common.AccountTypePersistence
	113, // 172: common.AddedAccountTypeLog.account_type:type_name -> common.AccountType
	12,  // 173: common.UpdatedDefaultEnforcementModeLog.enforcement_mode:type_name -> common.ChartEnforcementMode
	127, // 174: common.QueryFilter.field:type_name -> common.FieldCondition
	133, // 175: common.QueryFilter.address:type_name -> common.AddressMatch
	123, // 176: common.QueryFilter.and:type_name -> common.AndFilter
	124, // 177: common.QueryFilter.or:type_name -> common.OrFilter
	125, // 178: common.QueryFilter.not:type_name -> common.NotFilter
	118, // 179: common.QueryFilter.reference:type_name -> common.ReferenceCondition
	121, // 180: common.QueryFilter.builtin_uint:type_name -> common.BuiltinUintCondition
	119, // 181: common.QueryFilter.ledger:type_name -> common.LedgerCondition
	120, // 182: common.QueryFilter.log_id:type_name -> common.LogIdCondition
	122, // 183: common.QueryFilter.log_builtin_uint:type_name -> common.LogBuiltinUintCondition
	128, // 184: common.ReferenceCondition.cond:type_name -> common.StringCondition
	128, // 185: common.LedgerCondition.cond:type_name -> common.StringCondition
	130, // 186: common.LogIdCondition.cond:type_name -> common.UintCondition
	4,   // 187: common.BuiltinUintCondition.field:type_name -> common.TransactionBuiltinIndex
	130, // 188: common.BuiltinUintCondition.cond:type_name -> common.UintCondition
	6,   // 189: common.LogBuiltinUintCondition.field:type_name -> common.LogBuiltinIndex
	130, // 190: common.LogBuiltinUintCondition.cond:type_name -> common.UintCondition
	117, // 191: common.AndFilter.filters:type_name -> common.QueryFilter
	117, // 192: common.OrFilter.filters:type_name -> common.QueryFilter
	117, // 193: common.NotFilter.filter:type_name -> common.QueryFilter
	126, // 194: common.FieldCondition.field:type_name -> common.FieldRef
	128, // 195: common.FieldCondition.string_cond:type_name -> common.StringCondition
	129, // 196: common.FieldCondition.int_cond:type_name -> common.IntCondition
	130, // 197: common.FieldCondition.uint_cond:type_name -> common.UintCondition
	131, // 198: common.FieldCondition.bool_cond:type_name -> common.BoolCondition
	132, // 199: common.FieldCondition.exists_cond:type_name -> common.ExistsCondition
	15,  // 200: common.AddressMatch.role:type_name -> common.AddressRole
	117, // 201: common.PreparedQuery.filter:type_name -> common.QueryFilter
	16,  // 202: common.PreparedQuery.target:type_name -> common.QueryTarget
	23,  // 203: common.AggregatedVolume.input:type_name -> common.Uint256
	23,  // 204: common.AggregatedVolume.output:type_name -> common.Uint256
	135, // 205: common.AggregateResult.volumes:type_name -> common.AggregatedVolume
	137, // 206: common.AggregateResult.groups:type_name -> common.GroupedAggregateResult
	135, // 207: common.GroupedAggregateResult.volumes:type_name -> common.AggregatedVolume
	31,  // 208: common.PreparedQueryCursor.account_data:type_name -> common.Account
	25,  // 209: common.PreparedQueryCursor.transaction_data:type_name -> common.Transaction
	20,  // 210: common.MetadataMap.ValuesEntry.value:type_name -> common.MetadataValue
	20,  // 211: common.Transaction.MetadataEntry.value:type_name -> common.MetadataValue
	27,  // 212: common.VolumesByAssets.VolumesEntry.value:type_name -> common.Volumes
	29,  // 213: common.PostCommitVolumes.VolumesByAccountEntry.value:type_name -> common.VolumesByAssets
	20,  // 214: common.Account.MetadataEntry.value:type_name -> common.MetadataValue
	28,  // 215: common.Account.VolumesEntry.value:type_name -> common.VolumesWithBalance
	35,  // 216: common.MetadataSchema.AccountFieldsEntry.value:type_name -> common.MetadataFieldSchema
	35,  // 217: common.MetadataSchema.TransactionFieldsEntry.value:type_name -> common.MetadataFieldSchema
	113, // 218: common.CreateLedgerLog.AccountTypesEntry.value:type_name -> common.AccountType
	21,  // 219: common.CreatedTransaction.AccountMetadataEntry.value:type_name -> common.MetadataMap
	21,  // 220: common.CreatedTransaction.PreviousAccountMetadataEntry.value:type_name -> common.MetadataMap
	20,  // 221: common.SavedMetadata.MetadataEntry.value:type_name -> common.MetadataValue
	20,  // 222: common.SavedMetadata.PreviousValuesEntry.value:type_name -> common.MetadataValue
	113, // 223: common.LedgerInfo.AccountTypesEntry.value:type_name -> common.AccountType
	20,  // 224: common.SaveMetadataCommand.MetadataEntry.value:type_name -> common.MetadataValue
	20,  // 225: common.TransactionState.MetadataEntry.value:type_name -> common.MetadataValue
