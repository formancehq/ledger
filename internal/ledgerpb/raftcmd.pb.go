...
const file_raftcmd_proto_rawDesc = "" +
	...
	"\tCreateLog\x10\x02B7Z5github.com/formancehq/ledger-v3-poc/internal/ledgerpbb\x06proto3"
...
var file_raftcmd_proto_goTypes = []any{
	...
	(*LedgerInfo)(nil),                 // 20: common.LedgerInfo
	(*Posting)(nil),                    // 21: common.Posting
	(*Timestamp)(nil),                  // 22: common.Timestamp
	(*Transaction)(nil),                // 23: common.Transaction
	(*SaveMetadataCommand)(nil),        // 24: common.SaveMetadataCommand
	(*DeleteMetadataCommand)(nil),      // 25: common.DeleteMetadataCommand
	(*Idempotency)(nil),                // 26: common.Idempotency
	(*Metadata)(nil),                   // 27: common.Metadata
}
