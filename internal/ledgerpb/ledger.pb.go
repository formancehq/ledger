...
type LedgerInfo struct {
	...
	StoreDriver       string                 `protobuf:"bytes,3,opt,name=store_driver,json=storeDriver,proto3" json:"store_driver,omitempty"`                                                  // Store driver name (e.g., "sqlite-mattn", "sqlite-modern", "pebble", etc.)
	StoreConfig       *structpb.Struct       `protobuf:"bytes,4,opt,name=store_config,json=storeConfig,proto3" json:"store_config,omitempty"`                                                  // Store driver-specific configuration
...
func (x *LedgerInfo) GetStoreDriver() string {
	if x != nil {
...
func (x *LedgerInfo) GetStoreConfig() *structpb.Struct {
	if x != nil {
...
type LedgerState struct {
	...
	LastTransactionId uint64                 `protobuf:"varint,3,opt,name=last_transaction_id,json=lastTransactionId,proto3" json:"last_transaction_id,omitempty"`
	LastAppliedId     uint64                 `protobuf:"varint,4,opt,name=last_applied_id,json=lastAppliedId,proto3" json:"last_applied_id,omitempty"`
	StoreMetrics      *structpb.Struct       `protobuf:"bytes,5,opt,name=store_metrics,json=storeMetrics,proto3" json:"store_metrics,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *LedgerState) GetLastTransactionId() uint64 {
	if x != nil {
...
func (x *LedgerState) GetLastAppliedId() uint64 {
	if x != nil {
...
func (x *LedgerState) GetStoreMetrics() *structpb.Struct {
	if x != nil {
...
type AppendTransactionCommand struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	AccountMetadata map[string]*Metadata   `protobuf:"bytes,1,rep,name=account_metadata,json=accountMetadata,proto3" json:"account_metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Metadata        map[string]string      `protobuf:"bytes,2,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Timestamp       *Timestamp             `protobuf:"bytes,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	Reference       string                 `protobuf:"bytes,4,opt,name=reference,proto3" json:"reference,omitempty"`
...
const file_ledger_proto_rawDesc = "" +
	...
	"\x03log\x18\x01 \x01(\v2\v.ledger.LogR\x03log\"\x9b\x01\n" +
	"\x03Log\x12&\n" +
	...
	"\x02id\x18\x04 \x01(\x04R\x02id\"\xbe\x02\n" +
	"\n" +
	"LogPayload\x12M\n" +
	...
	"\x12revert_transaction\x18\x02 \x01(\v2\x19.ledger.TransactionResumeR\x11revertTransaction\"\x9d\x03\n" +
	"\n" +
	"LedgerInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12!\n" +
	"\fstore_driver\x18\x03 \x01(\tR\vstoreDriver\x12:\n" +
	"\fstore_config\x18\x04 \x01(\v2\x17.google.protobuf.StructR\vstoreConfig\x12<\n" +
	...
	"ledgerInfo\x12\x1e\n" +
	"\vlast_log_id\x18\x02 \x01(\x04R\tlastLogId\x12.\n" +
	"\x13last_transaction_id\x18\x03 \x01(\x04R\x11lastTransactionId\x12&\n" +
	"\x0flast_applied_id\x18\x04 \x01(\x04R\rlastAppliedId\x12<\n" +
	"\rstore_metrics\x18\x05 \x01(\v2\x17.google.protobuf.StructR\fstoreMetrics\"\xd7\x03\n" +
	"\x18AppendTransactionCommand\x12`\n" +
	"\x10account_metadata\x18\x01 \x03(\v25.ledger.AppendTransactionCommand.AccountMetadataEntryR\x0faccountMetadata\x12J\n" +
	...
	"\bpostings\x18\x05 \x03(\v2\x0f.ledger.PostingR\bpostings\x1aT\n" +
	"\x14AccountMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12&\n" +
	"\x05value\x18\x02 \x01(\v2\x10.ledger.MetadataR\x05value:\x028\x01\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	...
	"\x06target\x18\x01 \x01(\v2\x0e.ledger.TargetR\x06target\x12E\n" +
	"\bmetadata\x18\x02 \x03(\v2).ledger.SaveMetadataCommand.MetadataEntryR\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
...
var file_ledger_proto_msgTypes = make([]protoimpl.MessageInfo, 72)
var file_ledger_proto_goTypes = []any{
	...
	(*TargetAccount)(nil),                           // 35: ledger.TargetAccount
	(*TargetTransaction)(nil),                       // 36: ledger.TargetTransaction
	(*Target)(nil),                                  // 37: ledger.Target
	(*SavedMetadata)(nil),                           // 38: ledger.SavedMetadata
	(*DeletedMetadata)(nil),                         // 39: ledger.DeletedMetadata
	(*IdempotencyEntry)(nil),                        // 40: ledger.IdempotencyEntry
	(*Idempotency)(nil),                             // 41: ledger.Idempotency
	(*TransactionResume)(nil),                       // 42: ledger.TransactionResume
	(*CreatedTransactionMemento)(nil),               // 43: ledger.CreatedTransactionMemento
	(*RevertedTransactionMemento)(nil),              // 44: ledger.RevertedTransactionMemento
	(*LedgerInfo)(nil),                              // 45: ledger.LedgerInfo
	(*LedgerState)(nil),                             // 46: ledger.LedgerState
	(*AppendTransactionCommand)(nil),                // 47: ledger.AppendTransactionCommand
	(*SaveMetadataCommand)(nil),                     // 48: ledger.SaveMetadataCommand
	(*DeleteMetadataCommand)(nil),                   // 49: ledger.DeleteMetadataCommand
	(*RevertTransactionCommand)(nil),                // 50: ledger.RevertTransactionCommand
	(*CommandInput)(nil),                            // 51: ledger.CommandInput
	...
	nil,                                             // 69: ledger.AppendTransactionCommand.AccountMetadataEntry
	nil,                                             // 70: ledger.AppendTransactionCommand.MetadataEntry
	nil,                                             // 71: ledger.SaveMetadataCommand.MetadataEntry
...
var file_ledger_proto_depIdxs = []int32{
	...
	61, // 28: ledger.SaveAccountMetadataRequestPayload.metadata:type_name -> ledger.SaveAccountMetadataRequestPayload.MetadataEntry
	...
	62, // 31: ledger.RevertTransactionRequestPayload.metadata:type_name -> ledger.RevertTransactionRequestPayload.MetadataEntry
	...
	63, // 34: ledger.SaveTransactionMetadataRequestPayload.metadata:type_name -> ledger.SaveTransactionMetadataRequestPayload.MetadataEntry
	...
	41, // 44: ledger.Log.idempotency:type_name -> ledger.Idempotency
	33, // 45: ledger.LogPayload.created_transaction:type_name -> ledger.CreatedTransaction
	34, // 46: ledger.LogPayload.reverted_transaction:type_name -> ledger.RevertedTransaction
	38, // 47: ledger.LogPayload.saved_metadata:type_name -> ledger.SavedMetadata
	39, // 48: ledger.LogPayload.deleted_metadata:type_name -> ledger.DeletedMetadata
	3,  // 49: ledger.CreatedTransaction.transaction:type_name -> ledger.Transaction
	64, // 50: ledger.CreatedTransaction.account_metadata:type_name -> ledger.CreatedTransaction.AccountMetadataEntry
	3,  // 51: ledger.RevertedTransaction.reverted_transaction:type_name -> ledger.Transaction
	3,  // 52: ledger.RevertedTransaction.revert_transaction:type_name -> ledger.Transaction
	35, // 53: ledger.Target.account:type_name -> ledger.TargetAccount
	36, // 54: ledger.Target.transaction:type_name -> ledger.TargetTransaction
	37, // 55: ledger.SavedMetadata.target:type_name -> ledger.Target
	65, // 56: ledger.SavedMetadata.metadata:type_name -> ledger.SavedMetadata.MetadataEntry
	37, // 57: ledger.DeletedMetadata.target:type_name -> ledger.Target
	2,  // 58: ledger.TransactionResume.postings:type_name -> ledger.Posting
	66, // 59: ledger.TransactionResume.metadata:type_name -> ledger.TransactionResume.MetadataEntry
	0,  // 60: ledger.TransactionResume.timestamp:type_name -> ledger.Timestamp
	42, // 61: ledger.CreatedTransactionMemento.transaction:type_name -> ledger.TransactionResume
	67, // 62: ledger.CreatedTransactionMemento.account_metadata:type_name -> ledger.CreatedTransactionMemento.AccountMetadataEntry
	42, // 63: ledger.RevertedTransactionMemento.revert_transaction:type_name -> ledger.TransactionResume
	72, // 64: ledger.LedgerInfo.store_config:type_name -> google.protobuf.Struct
	68, // 65: ledger.LedgerInfo.metadata:type_name -> ledger.LedgerInfo.MetadataEntry
	0,  // 66: ledger.LedgerInfo.created_at:type_name -> ledger.Timestamp
	0,  // 67: ledger.LedgerInfo.deleted_at:type_name -> ledger.Timestamp
	45, // 68: ledger.LedgerState.ledger_info:type_name -> ledger.LedgerInfo
	72, // 69: ledger.LedgerState.store_metrics:type_name -> google.protobuf.Struct
	69, // 70: ledger.AppendTransactionCommand.account_metadata:type_name -> ledger.AppendTransactionCommand.AccountMetadataEntry
	70, // 71: ledger.AppendTransactionCommand.metadata:type_name -> ledger.AppendTransactionCommand.MetadataEntry
	0,  // 72: ledger.AppendTransactionCommand.timestamp:type_name -> ledger.Timestamp
	2,  // 73: ledger.AppendTransactionCommand.postings:type_name -> ledger.Posting
	37, // 74: ledger.SaveMetadataCommand.target:type_name -> ledger.Target
	71, // 75: ledger.SaveMetadataCommand.metadata:type_name -> ledger.SaveMetadataCommand.MetadataEntry
	37, // 76: ledger.DeleteMetadataCommand.target:type_name -> ledger.Target
	3,  // 77: ledger.RevertTransactionCommand.revert_transaction:type_name -> ledger.Transaction
	47, // 78: ledger.CommandInput.append_transaction:type_name -> ledger.AppendTransactionCommand
	48, // 79: ledger.CommandInput.save_metadata:type_name -> ledger.SaveMetadataCommand
	49, // 80: ledger.CommandInput.delete_metadata:type_name -> ledger.DeleteMetadataCommand
	50, // 81: ledger.CommandInput.revert_transaction:type_name -> ledger.RevertTransactionCommand
	6,  // 82: ledger.VolumesByAssets.VolumesEntry.value:type_name -> ledger.Volumes
	8,  // 83: ledger.PostCommitVolumes.VolumesByAccountEntry.value:type_name -> ledger.VolumesByAssets
	1,  // 84: ledger.CreateTransactionRequestPayload.AccountMetadataEntry.value:type_name -> ledger.Metadata
	1,  // 85: ledger.CreatedTransaction.AccountMetadataEntry.value:type_name -> ledger.Metadata
	1,  // 86: ledger.CreatedTransactionMemento.AccountMetadataEntry.value:type_name -> ledger.Metadata
	1,  // 87: ledger.AppendTransactionCommand.AccountMetadataEntry.value:type_name -> ledger.Metadata
	18, // 88: ledger.LedgerService.CreateTransaction:input_type -> ledger.CreateTransactionRequest
	22, // 89: ledger.LedgerService.RevertTransaction:input_type -> ledger.RevertTransactionRequest
	20, // 90: ledger.LedgerService.SaveAccountMetadata:input_type -> ledger.SaveAccountMetadataRequest
	24, // 91: ledger.LedgerService.SaveTransactionMetadata:input_type -> ledger.SaveTransactionMetadataRequest
	26, // 92: ledger.LedgerService.DeleteAccountMetadata:input_type -> ledger.DeleteAccountMetadataRequest
	28, // 93: ledger.LedgerService.DeleteTransactionMetadata:input_type -> ledger.DeleteTransactionMetadataRequest
	29, // 94: ledger.LedgerService.StreamLogs:input_type -> ledger.StreamLogsRequest
	31, // 95: ledger.LedgerService.CreateTransaction:output_type -> ledger.Log
	31, // 96: ledger.LedgerService.RevertTransaction:output_type -> ledger.Log
	31, // 97: ledger.LedgerService.SaveAccountMetadata:output_type -> ledger.Log
	31, // 98: ledger.LedgerService.SaveTransactionMetadata:output_type -> ledger.Log
	31, // 99: ledger.LedgerService.DeleteAccountMetadata:output_type -> ledger.Log
	31, // 100: ledger.LedgerService.DeleteTransactionMetadata:output_type -> ledger.Log
	30, // 101: ledger.LedgerService.StreamLogs:output_type -> ledger.StreamLogsResponse
