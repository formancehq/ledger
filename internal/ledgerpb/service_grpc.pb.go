...
type LedgerServiceClient interface {
	...
	CreateLedger(ctx context.Context, in *CreateLedgerRequest, opts ...grpc.CallOption) (*LedgerInfo, error)
...
func (c *ledgerServiceClient) CreateLedger(ctx context.Context, in *CreateLedgerRequest, opts ...grpc.CallOption) (*LedgerInfo, error) {
...
type LedgerServiceServer interface {
	// CreateLedger creates a new ledger
	CreateLedger(context.Context, *CreateLedgerRequest) (*LedgerInfo, error)
	// DeleteLedger deletes a ledger
...
func (UnimplementedLedgerServiceServer) CreateLedger(context.Context, *CreateLedgerRequest) (*LedgerInfo, error) {
