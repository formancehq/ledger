...
func (m *MockRuntimeStore) GetLogForIdempotencyKey(ctx context.Context, idempotencyKey string) ([]byte, uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockRuntimeStore) GetLogIDForTransactionID(ctx context.Context, transactionID uint64) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLogIDForTransactionID", ctx, transactionID)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRuntimeStoreMockRecorder) GetLogIDForTransactionID(ctx, transactionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLogIDForTransactionID", reflect.TypeOf((*MockRuntimeStore)(nil).GetLogIDForTransactionID), ctx, transactionID)
}
...
func (m *MockRuntimeStore) IsTransactionReverted(ctx context.Context, transactionID uint64) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsTransactionReverted", ctx, transactionID)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRuntimeStoreMockRecorder) IsTransactionReverted(ctx, transactionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsTransactionReverted", reflect.TypeOf((*MockRuntimeStore)(nil).IsTransactionReverted), ctx, transactionID)
}
