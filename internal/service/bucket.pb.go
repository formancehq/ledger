...
var file_proto_bucket_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_proto_bucket_proto_goTypes = []any{
	...
	nil,                               // 7: bucket.Script.VarsEntry
	nil,                               // 8: bucket.CreateTransactionRequest.AccountMetadataEntry
	nil,                               // 9: bucket.CreateTransactionResponse.AccountMetadataEntry
	(*timestamppb.Timestamp)(nil),     // 10: google.protobuf.Timestamp
	(*structpb.Struct)(nil),           // 11: google.protobuf.Struct
	(*Posting)(nil),                   // 12: common.Posting
	(*Transaction)(nil),               // 13: common.Transaction
}
var file_proto_bucket_proto_depIdxs = []int32{
	7,  // 0: bucket.Script.vars:type_name -> bucket.Script.VarsEntry
	8,  // 1: bucket.CreateTransactionRequest.account_metadata:type_name -> bucket.CreateTransactionRequest.AccountMetadataEntry
	10, // 2: bucket.CreateTransactionRequest.timestamp:type_name -> google.protobuf.Timestamp
	11, // 3: bucket.CreateTransactionRequest.metadata:type_name -> google.protobuf.Struct
	12, // 4: bucket.CreateTransactionRequest.postings:type_name -> common.Posting
	2,  // 5: bucket.CreateTransactionRequest.script:type_name -> bucket.Script
	13, // 6: bucket.CreateTransactionResponse.transaction:type_name -> common.Transaction
	9,  // 7: bucket.CreateTransactionResponse.account_metadata:type_name -> bucket.CreateTransactionResponse.AccountMetadataEntry
	11, // 8: bucket.CreateLedgerRequest.metadata:type_name -> google.protobuf.Struct
	11, // 9: bucket.CreateTransactionRequest.AccountMetadataEntry.value:type_name -> google.protobuf.Struct
	11, // 10: bucket.CreateTransactionResponse.AccountMetadataEntry.value:type_name -> google.protobuf.Struct
	0,  // 11: bucket.BucketService.Snapshot:input_type -> bucket.BucketSnapshotRequest
	5,  // 12: bucket.BucketService.CreateLedger:input_type -> bucket.CreateLedgerRequest
	3,  // 13: bucket.BucketService.CreateTransaction:input_type -> bucket.CreateTransactionRequest
	1,  // 14: bucket.BucketService.Snapshot:output_type -> bucket.BucketSnapshotResponse
	6,  // 15: bucket.BucketService.CreateLedger:output_type -> bucket.CreateLedgerResponse
	4,  // 16: bucket.BucketService.CreateTransaction:output_type -> bucket.CreateTransactionResponse
