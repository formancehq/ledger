...
func TestErrMsg(t *testing.T) {
	...
	t.Run("unexpected EOF", func(t *testing.T) {
		...
		require.Error(t, err)
		require.Equal(t, "expected a lowercase char, got EOF instead", err.Error())
	})
	...
	t.Run("missing closing bracket", func(t *testing.T) {
		...
		require.Error(t, err)
		require.Equal(t, "expected '}', got '!' instead", err.Error())
	})
	...
	t.Run("invalid var head char", func(t *testing.T) {
		...
		require.Error(t, err)
		require.Equal(t, "expected a lowercase char, got '2' instead", err.Error())
	})
}
