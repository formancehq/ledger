...
func (impl *LedgerServiceServerImpl) CreateLedger(ctx context.Context, req *ledgerpb.CreateLedgerRequest) (*ledgerpb.LedgerInfo, error) {
	return impl.ctrl.CreateLedger(ctx, &ledgerpb.CreateLedgerCommand{
		Name:     req.Name,
