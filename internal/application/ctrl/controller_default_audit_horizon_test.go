...
// The audit index can hold sequences past the audit head of the main-store
// view a read materializes from: candidates beyond that head must be trimmed,
// never surfaced as a missing entry.
