...
//go:generate go tool mockgen -write_source_comment=false -write_package_comment=false -source sink.go -destination sink_generated_test.go -typed -package events . Sink
