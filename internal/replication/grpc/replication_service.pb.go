...
type PipelineConfiguration struct {
	...
	AddressRewriteRules []*AddressRewriteRule  `protobuf:"bytes,3,rep,name=address_rewrite_rules,json=addressRewriteRules,proto3" json:"address_rewrite_rules,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *PipelineConfiguration) GetAddressRewriteRules() []*AddressRewriteRule {
	if x != nil {
...
func (x *ResetPipelineResponse) Reset() {
	*x = ResetPipelineResponse{}
	mi := &file_internal_replication_grpc_replication_service_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResetPipelineResponse) Descriptor() ([]byte, []int) {
	return file_internal_replication_grpc_replication_service_proto_rawDescGZIP(), []int{29}
}
...
const file_internal_replication_grpc_replication_service_proto_rawDesc = "" +
	...
	"\vreplacement\x18\x02 \x01(\tR\vreplacement\"\xa5\x01\n" +
	"\x15PipelineConfiguration\x12\x1f\n" +
	"\vexporter_id\x18\x01 \x01(\tR\n" +
	"exporterId\x12\x16\n" +
	"\x06ledger\x18\x02 \x01(\tR\x06ledger\x12S\n" +
	"\x15address_rewrite_rules\x18\x03 \x03(\v2\x1f.replication.AddressRewriteRuleR\x13addressRewriteRules\"\xf1\x01\n" +
	"\bPipeline\x12:\n" +
...
var file_internal_replication_grpc_replication_service_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_internal_replication_grpc_replication_service_proto_goTypes = []any{
	...
	(*AddressRewriteRule)(nil),     // 15: replication.AddressRewriteRule
	(*PipelineConfiguration)(nil),  // 16: replication.PipelineConfiguration
	(*Pipeline)(nil),               // 17: replication.Pipeline
	(*GetPipelineRequest)(nil),     // 18: replication.GetPipelineRequest
	(*GetPipelineResponse)(nil),    // 19: replication.GetPipelineResponse
	(*CreatePipelineRequest)(nil),  // 20: replication.CreatePipelineRequest
	(*CreatePipelineResponse)(nil), // 21: replication.CreatePipelineResponse
	(*DeletePipelineRequest)(nil),  // 22: replication.DeletePipelineRequest
	(*DeletePipelineResponse)(nil), // 23: replication.DeletePipelineResponse
	(*StartPipelineRequest)(nil),   // 24: replication.StartPipelineRequest
	(*StartPipelineResponse)(nil),  // 25: replication.StartPipelineResponse
	(*StopPipelineRequest)(nil),    // 26: replication.StopPipelineRequest
	(*StopPipelineResponse)(nil),   // 27: replication.StopPipelineResponse
	(*ResetPipelineRequest)(nil),   // 28: replication.ResetPipelineRequest
	(*ResetPipelineResponse)(nil),  // 29: replication.ResetPipelineResponse
...
var file_internal_replication_grpc_replication_service_proto_depIdxs = []int32{
	...
	30, // 2: replication.Exporter.created_at:type_name -> google.protobuf.Timestamp
	...
	17, // 8: replication.ListPipelinesResponse.data:type_name -> replication.Pipeline
	0,  // 9: replication.ListPipelinesResponse.cursor:type_name -> replication.Cursor
	15, // 10: replication.PipelineConfiguration.address_rewrite_rules:type_name -> replication.AddressRewriteRule
	16, // 11: replication.Pipeline.config:type_name -> replication.PipelineConfiguration
	30, // 12: replication.Pipeline.createdAt:type_name -> google.protobuf.Timestamp
	17, // 13: replication.GetPipelineResponse.pipeline:type_name -> replication.Pipeline
	16, // 14: replication.CreatePipelineRequest.config:type_name -> replication.PipelineConfiguration
	17, // 15: replication.CreatePipelineResponse.pipeline:type_name -> replication.Pipeline
	9,  // 16: replication.Replication.CreateExporter:input_type -> replication.CreateExporterRequest
	1,  // 17: replication.Replication.ListExporters:input_type -> replication.ListExportersRequest
	4,  // 18: replication.Replication.GetExporter:input_type -> replication.GetExporterRequest
	11, // 19: replication.Replication.UpdateExporter:input_type -> replication.UpdateExporterRequest
	6,  // 20: replication.Replication.DeleteExporter:input_type -> replication.DeleteExporterRequest
	13, // 21: replication.Replication.ListPipelines:input_type -> replication.ListPipelinesRequest
	18, // 22: replication.Replication.GetPipeline:input_type -> replication.GetPipelineRequest
	20, // 23: replication.Replication.CreatePipeline:input_type -> replication.CreatePipelineRequest
	22, // 24: replication.Replication.DeletePipeline:input_type -> replication.DeletePipelineRequest
	24, // 25: replication.Replication.StartPipeline:input_type -> replication.StartPipelineRequest
	26, // 26: replication.Replication.StopPipeline:input_type -> replication.StopPipelineRequest
	28, // 27: replication.Replication.ResetPipeline:input_type -> replication.ResetPipelineRequest
	10, // 28: replication.Replication.CreateExporter:output_type -> replication.CreateExporterResponse
	2,  // 29: replication.Replication.ListExporters:output_type -> replication.ListExportersResponse
	5,  // 30: replication.Replication.GetExporter:output_type -> replication.GetExporterResponse
	12, // 31: replication.Replication.UpdateExporter:output_type -> replication.UpdateExporterResponse
	7,  // 32: replication.Replication.DeleteExporter:output_type -> replication.DeleteExporterResponse
	14, // 33: replication.Replication.ListPipelines:output_type -> replication.ListPipelinesResponse
	19, // 34: replication.Replication.GetPipeline:output_type -> replication.GetPipelineResponse
	21, // 35: replication.Replication.CreatePipeline:output_type -> replication.CreatePipelineResponse
	23, // 36: replication.Replication.DeletePipeline:output_type -> replication.DeletePipelineResponse
	25, // 37: replication.Replication.StartPipeline:output_type -> replication.StartPipelineResponse
	27, // 38: replication.Replication.StopPipeline:output_type -> replication.StopPipelineResponse
	29, // 39: replication.Replication.ResetPipeline:output_type -> replication.ResetPipelineResponse
...
func file_internal_replication_grpc_replication_service_proto_init() {
	...
	file_internal_replication_grpc_replication_service_proto_msgTypes[17].OneofWrappers = []any{}
	type x struct{}
