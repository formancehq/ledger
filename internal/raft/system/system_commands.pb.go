...
type LedgerInfo struct {
	...
	DeletedAt         *ledgerpb.Timestamp    `protobuf:"bytes,8,opt,name=deleted_at,json=deletedAt,proto3" json:"deleted_at,omitempty"`                          // Deletion timestamp (optional, set when ledger is soft-deleted)
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *LedgerInfo) GetDeletedAt() *ledgerpb.Timestamp {
	if x != nil {
		return x.DeletedAt
	}
	return nil
...
const file_commands_system_commands_proto_rawDesc = "" +
	...
	"\n" +
	"deleted_at\x18\b \x01(\v2\x11.ledger.TimestampR\tdeletedAt\"\x9b\x03\n" +
...
var file_commands_system_commands_proto_depIdxs = []int32{
	...
	8,  // 5: fsm_commands.LedgerInfo.deleted_at:type_name -> ledger.Timestamp
	5,  // 6: fsm_commands.SystemFSMSnapshot.ledgers:type_name -> fsm_commands.SystemFSMSnapshot.LedgersEntry
	6,  // 7: fsm_commands.SystemFSMSnapshot.buckets:type_name -> fsm_commands.SystemFSMSnapshot.BucketsEntry
	7,  // 8: fsm_commands.BucketInfo.config:type_name -> google.protobuf.Struct
	8,  // 9: fsm_commands.BucketInfo.created_at:type_name -> ledger.Timestamp
	2,  // 10: fsm_commands.SystemFSMSnapshot.LedgersEntry.value:type_name -> fsm_commands.LedgerInfo
	4,  // 11: fsm_commands.SystemFSMSnapshot.BucketsEntry.value:type_name -> fsm_commands.BucketInfo
