...
const file_proto_raft_transport_proto_rawDesc = "" +
	"\n" +
	"\x1aproto/raft_transport.proto\x12\x0eraft_transport\".\n" +
	...
	"\vSendMessage\x12\".raft_transport.SendMessageRequest\x1a#.raft_transport.SendMessageResponseB3Z1github.com/formancehq/ledger-v3-poc/internal/raftb\x06proto3"
...
var file_proto_raft_transport_proto_depIdxs = []int32{
	0, // 0: raft_transport.RaftTransportService.SendMessage:input_type -> raft_transport.SendMessageRequest
	1, // 1: raft_transport.RaftTransportService.SendMessage:output_type -> raft_transport.SendMessageResponse
