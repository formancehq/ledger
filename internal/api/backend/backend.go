...
type Ledger interface {
	...
	RevertTransaction(ctx context.Context, parameters command.Parameters, id *big.Int, force, atEffectiveDate bool, data ledger.RunScript) (*ledger.Transaction, error)
