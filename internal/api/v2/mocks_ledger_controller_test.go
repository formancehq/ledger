...
//
//	mockgen -write_source_comment=false -write_package_comment=false -source internal/controller/ledger/controller.go -destination internal/api/v2/mocks_ledger_controller_test.go -package v2 --mock_names Controller=LedgerController . Controller
//
