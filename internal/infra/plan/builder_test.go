...
func TestProposalGuard_ReleaseLoaders(t *testing.T) {
	...
	_, err := loaders.Volumes.LoadOrWait(key, preload.CacheStamp{Boundary: 100, Epoch: testCacheEpoch}, func() (*raftcmdpb.VolumePair, error) {
...
func TestProposalGuard_ReleaseAll(t *testing.T) {
	...
	_, err := loaders.References.LoadOrWait(key, preload.CacheStamp{Boundary: 100, Epoch: testCacheEpoch}, func() (*commonpb.TransactionReferenceValue, error) {
